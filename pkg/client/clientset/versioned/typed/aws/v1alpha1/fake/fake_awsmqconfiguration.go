...
func (c *FakeAwsMqConfigurations) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsMqConfiguration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsmqconfigurationsResource, c.ns, name), &v1alpha1.AwsMqConfiguration{})
...
func (c *FakeAwsMqConfigurations) List(opts v1.ListOptions) (result *v1alpha1.AwsMqConfigurationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsmqconfigurationsResource, awsmqconfigurationsKind, c.ns, opts), &v1alpha1.AwsMqConfigurationList{})
	...
	list := &v1alpha1.AwsMqConfigurationList{}
...
func (c *FakeAwsMqConfigurations) Create(awsMqConfiguration *v1alpha1.AwsMqConfiguration) (result *v1alpha1.AwsMqConfiguration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsmqconfigurationsResource, c.ns, awsMqConfiguration), &v1alpha1.AwsMqConfiguration{})
...
func (c *FakeAwsMqConfigurations) Update(awsMqConfiguration *v1alpha1.AwsMqConfiguration) (result *v1alpha1.AwsMqConfiguration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsmqconfigurationsResource, c.ns, awsMqConfiguration), &v1alpha1.AwsMqConfiguration{})
...
func (c *FakeAwsMqConfigurations) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsmqconfigurationsResource, c.ns, name), &v1alpha1.AwsMqConfiguration{})
...
func (c *FakeAwsMqConfigurations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsMqConfiguration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsmqconfigurationsResource, c.ns, name, data, subresources...), &v1alpha1.AwsMqConfiguration{})
