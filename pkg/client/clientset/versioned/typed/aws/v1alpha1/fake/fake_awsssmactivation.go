...
func (c *FakeAwsSsmActivations) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsSsmActivation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsssmactivationsResource, c.ns, name), &v1alpha1.AwsSsmActivation{})
...
func (c *FakeAwsSsmActivations) List(opts v1.ListOptions) (result *v1alpha1.AwsSsmActivationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsssmactivationsResource, awsssmactivationsKind, c.ns, opts), &v1alpha1.AwsSsmActivationList{})
	...
	list := &v1alpha1.AwsSsmActivationList{}
...
func (c *FakeAwsSsmActivations) Create(awsSsmActivation *v1alpha1.AwsSsmActivation) (result *v1alpha1.AwsSsmActivation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsssmactivationsResource, c.ns, awsSsmActivation), &v1alpha1.AwsSsmActivation{})
...
func (c *FakeAwsSsmActivations) Update(awsSsmActivation *v1alpha1.AwsSsmActivation) (result *v1alpha1.AwsSsmActivation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsssmactivationsResource, c.ns, awsSsmActivation), &v1alpha1.AwsSsmActivation{})
...
func (c *FakeAwsSsmActivations) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsssmactivationsResource, c.ns, name), &v1alpha1.AwsSsmActivation{})
...
func (c *FakeAwsSsmActivations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsSsmActivation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsssmactivationsResource, c.ns, name, data, subresources...), &v1alpha1.AwsSsmActivation{})
