...
var awsapigatewaygatewayresponsesResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awsapigatewaygatewayresponses"}

var awsapigatewaygatewayresponsesKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsApiGatewayGatewayResponse"}
...
func (c *FakeAwsApiGatewayGatewayResponses) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsApiGatewayGatewayResponse, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsapigatewaygatewayresponsesResource, c.ns, name), &v1alpha1.AwsApiGatewayGatewayResponse{})
...
func (c *FakeAwsApiGatewayGatewayResponses) List(opts v1.ListOptions) (result *v1alpha1.AwsApiGatewayGatewayResponseList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsapigatewaygatewayresponsesResource, awsapigatewaygatewayresponsesKind, c.ns, opts), &v1alpha1.AwsApiGatewayGatewayResponseList{})
	...
	list := &v1alpha1.AwsApiGatewayGatewayResponseList{}
...
func (c *FakeAwsApiGatewayGatewayResponses) Create(awsApiGatewayGatewayResponse *v1alpha1.AwsApiGatewayGatewayResponse) (result *v1alpha1.AwsApiGatewayGatewayResponse, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsapigatewaygatewayresponsesResource, c.ns, awsApiGatewayGatewayResponse), &v1alpha1.AwsApiGatewayGatewayResponse{})
...
func (c *FakeAwsApiGatewayGatewayResponses) Update(awsApiGatewayGatewayResponse *v1alpha1.AwsApiGatewayGatewayResponse) (result *v1alpha1.AwsApiGatewayGatewayResponse, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsapigatewaygatewayresponsesResource, c.ns, awsApiGatewayGatewayResponse), &v1alpha1.AwsApiGatewayGatewayResponse{})
...
func (c *FakeAwsApiGatewayGatewayResponses) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsapigatewaygatewayresponsesResource, c.ns, name), &v1alpha1.AwsApiGatewayGatewayResponse{})
...
func (c *FakeAwsApiGatewayGatewayResponses) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsApiGatewayGatewayResponse, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsapigatewaygatewayresponsesResource, c.ns, name, data, subresources...), &v1alpha1.AwsApiGatewayGatewayResponse{})
