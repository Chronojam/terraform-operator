...
func (c *FakeAwsOpsworksPermissions) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsOpsworksPermission, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsopsworkspermissionsResource, c.ns, name), &v1alpha1.AwsOpsworksPermission{})
...
func (c *FakeAwsOpsworksPermissions) List(opts v1.ListOptions) (result *v1alpha1.AwsOpsworksPermissionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsopsworkspermissionsResource, awsopsworkspermissionsKind, c.ns, opts), &v1alpha1.AwsOpsworksPermissionList{})
	...
	list := &v1alpha1.AwsOpsworksPermissionList{}
...
func (c *FakeAwsOpsworksPermissions) Create(awsOpsworksPermission *v1alpha1.AwsOpsworksPermission) (result *v1alpha1.AwsOpsworksPermission, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsopsworkspermissionsResource, c.ns, awsOpsworksPermission), &v1alpha1.AwsOpsworksPermission{})
...
func (c *FakeAwsOpsworksPermissions) Update(awsOpsworksPermission *v1alpha1.AwsOpsworksPermission) (result *v1alpha1.AwsOpsworksPermission, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsopsworkspermissionsResource, c.ns, awsOpsworksPermission), &v1alpha1.AwsOpsworksPermission{})
...
func (c *FakeAwsOpsworksPermissions) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsopsworkspermissionsResource, c.ns, name), &v1alpha1.AwsOpsworksPermission{})
...
func (c *FakeAwsOpsworksPermissions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsOpsworksPermission, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsopsworkspermissionsResource, c.ns, name, data, subresources...), &v1alpha1.AwsOpsworksPermission{})
