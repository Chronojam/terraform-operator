...
func (c *FakeAwsCloudwatchDashboards) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsCloudwatchDashboard, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awscloudwatchdashboardsResource, c.ns, name), &v1alpha1.AwsCloudwatchDashboard{})
...
func (c *FakeAwsCloudwatchDashboards) List(opts v1.ListOptions) (result *v1alpha1.AwsCloudwatchDashboardList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awscloudwatchdashboardsResource, awscloudwatchdashboardsKind, c.ns, opts), &v1alpha1.AwsCloudwatchDashboardList{})
	...
	list := &v1alpha1.AwsCloudwatchDashboardList{}
...
func (c *FakeAwsCloudwatchDashboards) Create(awsCloudwatchDashboard *v1alpha1.AwsCloudwatchDashboard) (result *v1alpha1.AwsCloudwatchDashboard, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awscloudwatchdashboardsResource, c.ns, awsCloudwatchDashboard), &v1alpha1.AwsCloudwatchDashboard{})
...
func (c *FakeAwsCloudwatchDashboards) Update(awsCloudwatchDashboard *v1alpha1.AwsCloudwatchDashboard) (result *v1alpha1.AwsCloudwatchDashboard, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awscloudwatchdashboardsResource, c.ns, awsCloudwatchDashboard), &v1alpha1.AwsCloudwatchDashboard{})
...
func (c *FakeAwsCloudwatchDashboards) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awscloudwatchdashboardsResource, c.ns, name), &v1alpha1.AwsCloudwatchDashboard{})
...
func (c *FakeAwsCloudwatchDashboards) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsCloudwatchDashboard, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awscloudwatchdashboardsResource, c.ns, name, data, subresources...), &v1alpha1.AwsCloudwatchDashboard{})
