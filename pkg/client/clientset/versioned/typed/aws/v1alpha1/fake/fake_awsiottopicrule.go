...
func (c *FakeAwsIotTopicRules) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsIotTopicRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsiottopicrulesResource, c.ns, name), &v1alpha1.AwsIotTopicRule{})
...
func (c *FakeAwsIotTopicRules) List(opts v1.ListOptions) (result *v1alpha1.AwsIotTopicRuleList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsiottopicrulesResource, awsiottopicrulesKind, c.ns, opts), &v1alpha1.AwsIotTopicRuleList{})
	...
	list := &v1alpha1.AwsIotTopicRuleList{}
...
func (c *FakeAwsIotTopicRules) Create(awsIotTopicRule *v1alpha1.AwsIotTopicRule) (result *v1alpha1.AwsIotTopicRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsiottopicrulesResource, c.ns, awsIotTopicRule), &v1alpha1.AwsIotTopicRule{})
...
func (c *FakeAwsIotTopicRules) Update(awsIotTopicRule *v1alpha1.AwsIotTopicRule) (result *v1alpha1.AwsIotTopicRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsiottopicrulesResource, c.ns, awsIotTopicRule), &v1alpha1.AwsIotTopicRule{})
...
func (c *FakeAwsIotTopicRules) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsiottopicrulesResource, c.ns, name), &v1alpha1.AwsIotTopicRule{})
...
func (c *FakeAwsIotTopicRules) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsIotTopicRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsiottopicrulesResource, c.ns, name, data, subresources...), &v1alpha1.AwsIotTopicRule{})
