...
var awsdbparametergroupsResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awsdbparametergroups"}

var awsdbparametergroupsKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsDbParameterGroup"}
...
func (c *FakeAwsDbParameterGroups) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsDbParameterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsdbparametergroupsResource, c.ns, name), &v1alpha1.AwsDbParameterGroup{})
...
func (c *FakeAwsDbParameterGroups) List(opts v1.ListOptions) (result *v1alpha1.AwsDbParameterGroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsdbparametergroupsResource, awsdbparametergroupsKind, c.ns, opts), &v1alpha1.AwsDbParameterGroupList{})
	...
	list := &v1alpha1.AwsDbParameterGroupList{}
...
func (c *FakeAwsDbParameterGroups) Create(awsDbParameterGroup *v1alpha1.AwsDbParameterGroup) (result *v1alpha1.AwsDbParameterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsdbparametergroupsResource, c.ns, awsDbParameterGroup), &v1alpha1.AwsDbParameterGroup{})
...
func (c *FakeAwsDbParameterGroups) Update(awsDbParameterGroup *v1alpha1.AwsDbParameterGroup) (result *v1alpha1.AwsDbParameterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsdbparametergroupsResource, c.ns, awsDbParameterGroup), &v1alpha1.AwsDbParameterGroup{})
...
func (c *FakeAwsDbParameterGroups) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsdbparametergroupsResource, c.ns, name), &v1alpha1.AwsDbParameterGroup{})
...
func (c *FakeAwsDbParameterGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsDbParameterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsdbparametergroupsResource, c.ns, name, data, subresources...), &v1alpha1.AwsDbParameterGroup{})
