...
func (c *FakeAwsSfnActivities) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsSfnActivity, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awssfnactivitiesResource, c.ns, name), &v1alpha1.AwsSfnActivity{})
...
func (c *FakeAwsSfnActivities) List(opts v1.ListOptions) (result *v1alpha1.AwsSfnActivityList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awssfnactivitiesResource, awssfnactivitiesKind, c.ns, opts), &v1alpha1.AwsSfnActivityList{})
	...
	list := &v1alpha1.AwsSfnActivityList{}
...
func (c *FakeAwsSfnActivities) Create(awsSfnActivity *v1alpha1.AwsSfnActivity) (result *v1alpha1.AwsSfnActivity, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awssfnactivitiesResource, c.ns, awsSfnActivity), &v1alpha1.AwsSfnActivity{})
...
func (c *FakeAwsSfnActivities) Update(awsSfnActivity *v1alpha1.AwsSfnActivity) (result *v1alpha1.AwsSfnActivity, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awssfnactivitiesResource, c.ns, awsSfnActivity), &v1alpha1.AwsSfnActivity{})
...
func (c *FakeAwsSfnActivities) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awssfnactivitiesResource, c.ns, name), &v1alpha1.AwsSfnActivity{})
...
func (c *FakeAwsSfnActivities) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsSfnActivity, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awssfnactivitiesResource, c.ns, name, data, subresources...), &v1alpha1.AwsSfnActivity{})
