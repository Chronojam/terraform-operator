...
var awsiamgrouppoliciesResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awsiamgrouppolicies"}

var awsiamgrouppoliciesKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsIamGroupPolicy"}
...
func (c *FakeAwsIamGroupPolicies) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsIamGroupPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsiamgrouppoliciesResource, c.ns, name), &v1alpha1.AwsIamGroupPolicy{})
...
func (c *FakeAwsIamGroupPolicies) List(opts v1.ListOptions) (result *v1alpha1.AwsIamGroupPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsiamgrouppoliciesResource, awsiamgrouppoliciesKind, c.ns, opts), &v1alpha1.AwsIamGroupPolicyList{})
	...
	list := &v1alpha1.AwsIamGroupPolicyList{}
...
func (c *FakeAwsIamGroupPolicies) Create(awsIamGroupPolicy *v1alpha1.AwsIamGroupPolicy) (result *v1alpha1.AwsIamGroupPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsiamgrouppoliciesResource, c.ns, awsIamGroupPolicy), &v1alpha1.AwsIamGroupPolicy{})
...
func (c *FakeAwsIamGroupPolicies) Update(awsIamGroupPolicy *v1alpha1.AwsIamGroupPolicy) (result *v1alpha1.AwsIamGroupPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsiamgrouppoliciesResource, c.ns, awsIamGroupPolicy), &v1alpha1.AwsIamGroupPolicy{})
...
func (c *FakeAwsIamGroupPolicies) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsiamgrouppoliciesResource, c.ns, name), &v1alpha1.AwsIamGroupPolicy{})
...
func (c *FakeAwsIamGroupPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsIamGroupPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsiamgrouppoliciesResource, c.ns, name, data, subresources...), &v1alpha1.AwsIamGroupPolicy{})
