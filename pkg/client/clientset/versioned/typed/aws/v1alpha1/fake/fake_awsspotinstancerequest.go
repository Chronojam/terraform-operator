...
func (c *FakeAwsSpotInstanceRequests) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsSpotInstanceRequest, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsspotinstancerequestsResource, c.ns, name), &v1alpha1.AwsSpotInstanceRequest{})
...
func (c *FakeAwsSpotInstanceRequests) List(opts v1.ListOptions) (result *v1alpha1.AwsSpotInstanceRequestList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsspotinstancerequestsResource, awsspotinstancerequestsKind, c.ns, opts), &v1alpha1.AwsSpotInstanceRequestList{})
	...
	list := &v1alpha1.AwsSpotInstanceRequestList{}
...
func (c *FakeAwsSpotInstanceRequests) Create(awsSpotInstanceRequest *v1alpha1.AwsSpotInstanceRequest) (result *v1alpha1.AwsSpotInstanceRequest, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsspotinstancerequestsResource, c.ns, awsSpotInstanceRequest), &v1alpha1.AwsSpotInstanceRequest{})
...
func (c *FakeAwsSpotInstanceRequests) Update(awsSpotInstanceRequest *v1alpha1.AwsSpotInstanceRequest) (result *v1alpha1.AwsSpotInstanceRequest, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsspotinstancerequestsResource, c.ns, awsSpotInstanceRequest), &v1alpha1.AwsSpotInstanceRequest{})
...
func (c *FakeAwsSpotInstanceRequests) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsspotinstancerequestsResource, c.ns, name), &v1alpha1.AwsSpotInstanceRequest{})
...
func (c *FakeAwsSpotInstanceRequests) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsSpotInstanceRequest, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsspotinstancerequestsResource, c.ns, name, data, subresources...), &v1alpha1.AwsSpotInstanceRequest{})
