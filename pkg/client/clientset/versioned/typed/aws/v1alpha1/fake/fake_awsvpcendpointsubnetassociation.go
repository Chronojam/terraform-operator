...
func (c *FakeAwsVpcEndpointSubnetAssociations) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsVpcEndpointSubnetAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsvpcendpointsubnetassociationsResource, c.ns, name), &v1alpha1.AwsVpcEndpointSubnetAssociation{})
...
func (c *FakeAwsVpcEndpointSubnetAssociations) List(opts v1.ListOptions) (result *v1alpha1.AwsVpcEndpointSubnetAssociationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsvpcendpointsubnetassociationsResource, awsvpcendpointsubnetassociationsKind, c.ns, opts), &v1alpha1.AwsVpcEndpointSubnetAssociationList{})
	...
	list := &v1alpha1.AwsVpcEndpointSubnetAssociationList{}
...
func (c *FakeAwsVpcEndpointSubnetAssociations) Create(awsVpcEndpointSubnetAssociation *v1alpha1.AwsVpcEndpointSubnetAssociation) (result *v1alpha1.AwsVpcEndpointSubnetAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsvpcendpointsubnetassociationsResource, c.ns, awsVpcEndpointSubnetAssociation), &v1alpha1.AwsVpcEndpointSubnetAssociation{})
...
func (c *FakeAwsVpcEndpointSubnetAssociations) Update(awsVpcEndpointSubnetAssociation *v1alpha1.AwsVpcEndpointSubnetAssociation) (result *v1alpha1.AwsVpcEndpointSubnetAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsvpcendpointsubnetassociationsResource, c.ns, awsVpcEndpointSubnetAssociation), &v1alpha1.AwsVpcEndpointSubnetAssociation{})
...
func (c *FakeAwsVpcEndpointSubnetAssociations) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsvpcendpointsubnetassociationsResource, c.ns, name), &v1alpha1.AwsVpcEndpointSubnetAssociation{})
...
func (c *FakeAwsVpcEndpointSubnetAssociations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsVpcEndpointSubnetAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsvpcendpointsubnetassociationsResource, c.ns, name, data, subresources...), &v1alpha1.AwsVpcEndpointSubnetAssociation{})
