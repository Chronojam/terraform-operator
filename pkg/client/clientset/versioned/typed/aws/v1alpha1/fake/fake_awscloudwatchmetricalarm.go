...
func (c *FakeAwsCloudwatchMetricAlarms) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsCloudwatchMetricAlarm, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awscloudwatchmetricalarmsResource, c.ns, name), &v1alpha1.AwsCloudwatchMetricAlarm{})
...
func (c *FakeAwsCloudwatchMetricAlarms) List(opts v1.ListOptions) (result *v1alpha1.AwsCloudwatchMetricAlarmList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awscloudwatchmetricalarmsResource, awscloudwatchmetricalarmsKind, c.ns, opts), &v1alpha1.AwsCloudwatchMetricAlarmList{})
	...
	list := &v1alpha1.AwsCloudwatchMetricAlarmList{}
...
func (c *FakeAwsCloudwatchMetricAlarms) Create(awsCloudwatchMetricAlarm *v1alpha1.AwsCloudwatchMetricAlarm) (result *v1alpha1.AwsCloudwatchMetricAlarm, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awscloudwatchmetricalarmsResource, c.ns, awsCloudwatchMetricAlarm), &v1alpha1.AwsCloudwatchMetricAlarm{})
...
func (c *FakeAwsCloudwatchMetricAlarms) Update(awsCloudwatchMetricAlarm *v1alpha1.AwsCloudwatchMetricAlarm) (result *v1alpha1.AwsCloudwatchMetricAlarm, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awscloudwatchmetricalarmsResource, c.ns, awsCloudwatchMetricAlarm), &v1alpha1.AwsCloudwatchMetricAlarm{})
...
func (c *FakeAwsCloudwatchMetricAlarms) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awscloudwatchmetricalarmsResource, c.ns, name), &v1alpha1.AwsCloudwatchMetricAlarm{})
...
func (c *FakeAwsCloudwatchMetricAlarms) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsCloudwatchMetricAlarm, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awscloudwatchmetricalarmsResource, c.ns, name, data, subresources...), &v1alpha1.AwsCloudwatchMetricAlarm{})
