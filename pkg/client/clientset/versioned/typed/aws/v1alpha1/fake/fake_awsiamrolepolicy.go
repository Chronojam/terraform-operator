...
var awsiamrolepoliciesResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awsiamrolepolicies"}

var awsiamrolepoliciesKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsIamRolePolicy"}
...
func (c *FakeAwsIamRolePolicies) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsIamRolePolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsiamrolepoliciesResource, c.ns, name), &v1alpha1.AwsIamRolePolicy{})
...
func (c *FakeAwsIamRolePolicies) List(opts v1.ListOptions) (result *v1alpha1.AwsIamRolePolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsiamrolepoliciesResource, awsiamrolepoliciesKind, c.ns, opts), &v1alpha1.AwsIamRolePolicyList{})
	...
	list := &v1alpha1.AwsIamRolePolicyList{}
...
func (c *FakeAwsIamRolePolicies) Create(awsIamRolePolicy *v1alpha1.AwsIamRolePolicy) (result *v1alpha1.AwsIamRolePolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsiamrolepoliciesResource, c.ns, awsIamRolePolicy), &v1alpha1.AwsIamRolePolicy{})
...
func (c *FakeAwsIamRolePolicies) Update(awsIamRolePolicy *v1alpha1.AwsIamRolePolicy) (result *v1alpha1.AwsIamRolePolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsiamrolepoliciesResource, c.ns, awsIamRolePolicy), &v1alpha1.AwsIamRolePolicy{})
...
func (c *FakeAwsIamRolePolicies) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsiamrolepoliciesResource, c.ns, name), &v1alpha1.AwsIamRolePolicy{})
...
func (c *FakeAwsIamRolePolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsIamRolePolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsiamrolepoliciesResource, c.ns, name, data, subresources...), &v1alpha1.AwsIamRolePolicy{})
