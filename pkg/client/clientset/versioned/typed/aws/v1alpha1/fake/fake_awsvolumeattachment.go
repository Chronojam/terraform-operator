...
func (c *FakeAwsVolumeAttachments) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsVolumeAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsvolumeattachmentsResource, c.ns, name), &v1alpha1.AwsVolumeAttachment{})
...
func (c *FakeAwsVolumeAttachments) List(opts v1.ListOptions) (result *v1alpha1.AwsVolumeAttachmentList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsvolumeattachmentsResource, awsvolumeattachmentsKind, c.ns, opts), &v1alpha1.AwsVolumeAttachmentList{})
	...
	list := &v1alpha1.AwsVolumeAttachmentList{}
...
func (c *FakeAwsVolumeAttachments) Create(awsVolumeAttachment *v1alpha1.AwsVolumeAttachment) (result *v1alpha1.AwsVolumeAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsvolumeattachmentsResource, c.ns, awsVolumeAttachment), &v1alpha1.AwsVolumeAttachment{})
...
func (c *FakeAwsVolumeAttachments) Update(awsVolumeAttachment *v1alpha1.AwsVolumeAttachment) (result *v1alpha1.AwsVolumeAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsvolumeattachmentsResource, c.ns, awsVolumeAttachment), &v1alpha1.AwsVolumeAttachment{})
...
func (c *FakeAwsVolumeAttachments) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsvolumeattachmentsResource, c.ns, name), &v1alpha1.AwsVolumeAttachment{})
...
func (c *FakeAwsVolumeAttachments) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsVolumeAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsvolumeattachmentsResource, c.ns, name, data, subresources...), &v1alpha1.AwsVolumeAttachment{})
