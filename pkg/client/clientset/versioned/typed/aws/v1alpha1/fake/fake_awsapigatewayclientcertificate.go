...
func (c *FakeAwsApiGatewayClientCertificates) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsApiGatewayClientCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsapigatewayclientcertificatesResource, c.ns, name), &v1alpha1.AwsApiGatewayClientCertificate{})
...
func (c *FakeAwsApiGatewayClientCertificates) List(opts v1.ListOptions) (result *v1alpha1.AwsApiGatewayClientCertificateList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsapigatewayclientcertificatesResource, awsapigatewayclientcertificatesKind, c.ns, opts), &v1alpha1.AwsApiGatewayClientCertificateList{})
	...
	list := &v1alpha1.AwsApiGatewayClientCertificateList{}
...
func (c *FakeAwsApiGatewayClientCertificates) Create(awsApiGatewayClientCertificate *v1alpha1.AwsApiGatewayClientCertificate) (result *v1alpha1.AwsApiGatewayClientCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsapigatewayclientcertificatesResource, c.ns, awsApiGatewayClientCertificate), &v1alpha1.AwsApiGatewayClientCertificate{})
...
func (c *FakeAwsApiGatewayClientCertificates) Update(awsApiGatewayClientCertificate *v1alpha1.AwsApiGatewayClientCertificate) (result *v1alpha1.AwsApiGatewayClientCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsapigatewayclientcertificatesResource, c.ns, awsApiGatewayClientCertificate), &v1alpha1.AwsApiGatewayClientCertificate{})
...
func (c *FakeAwsApiGatewayClientCertificates) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsapigatewayclientcertificatesResource, c.ns, name), &v1alpha1.AwsApiGatewayClientCertificate{})
...
func (c *FakeAwsApiGatewayClientCertificates) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsApiGatewayClientCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsapigatewayclientcertificatesResource, c.ns, name, data, subresources...), &v1alpha1.AwsApiGatewayClientCertificate{})
