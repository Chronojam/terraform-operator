...
var awslbsResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awslbs"}

var awslbsKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsLb"}
...
func (c *FakeAwsLbs) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsLb, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awslbsResource, c.ns, name), &v1alpha1.AwsLb{})
...
func (c *FakeAwsLbs) List(opts v1.ListOptions) (result *v1alpha1.AwsLbList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awslbsResource, awslbsKind, c.ns, opts), &v1alpha1.AwsLbList{})
...
func (c *FakeAwsLbs) Create(awsLb *v1alpha1.AwsLb) (result *v1alpha1.AwsLb, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awslbsResource, c.ns, awsLb), &v1alpha1.AwsLb{})
...
func (c *FakeAwsLbs) Update(awsLb *v1alpha1.AwsLb) (result *v1alpha1.AwsLb, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awslbsResource, c.ns, awsLb), &v1alpha1.AwsLb{})
...
func (c *FakeAwsLbs) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awslbsResource, c.ns, name), &v1alpha1.AwsLb{})
...
func (c *FakeAwsLbs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsLb, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awslbsResource, c.ns, name, data, subresources...), &v1alpha1.AwsLb{})
