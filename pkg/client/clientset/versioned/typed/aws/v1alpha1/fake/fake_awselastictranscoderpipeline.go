...
func (c *FakeAwsElastictranscoderPipelines) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsElastictranscoderPipeline, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awselastictranscoderpipelinesResource, c.ns, name), &v1alpha1.AwsElastictranscoderPipeline{})
...
func (c *FakeAwsElastictranscoderPipelines) List(opts v1.ListOptions) (result *v1alpha1.AwsElastictranscoderPipelineList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awselastictranscoderpipelinesResource, awselastictranscoderpipelinesKind, c.ns, opts), &v1alpha1.AwsElastictranscoderPipelineList{})
	...
	list := &v1alpha1.AwsElastictranscoderPipelineList{}
...
func (c *FakeAwsElastictranscoderPipelines) Create(awsElastictranscoderPipeline *v1alpha1.AwsElastictranscoderPipeline) (result *v1alpha1.AwsElastictranscoderPipeline, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awselastictranscoderpipelinesResource, c.ns, awsElastictranscoderPipeline), &v1alpha1.AwsElastictranscoderPipeline{})
...
func (c *FakeAwsElastictranscoderPipelines) Update(awsElastictranscoderPipeline *v1alpha1.AwsElastictranscoderPipeline) (result *v1alpha1.AwsElastictranscoderPipeline, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awselastictranscoderpipelinesResource, c.ns, awsElastictranscoderPipeline), &v1alpha1.AwsElastictranscoderPipeline{})
...
func (c *FakeAwsElastictranscoderPipelines) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awselastictranscoderpipelinesResource, c.ns, name), &v1alpha1.AwsElastictranscoderPipeline{})
...
func (c *FakeAwsElastictranscoderPipelines) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsElastictranscoderPipeline, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awselastictranscoderpipelinesResource, c.ns, name, data, subresources...), &v1alpha1.AwsElastictranscoderPipeline{})
