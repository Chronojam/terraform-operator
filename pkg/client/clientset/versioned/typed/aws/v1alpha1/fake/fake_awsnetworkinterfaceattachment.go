...
var awsnetworkinterfaceattachmentsResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awsnetworkinterfaceattachments"}

var awsnetworkinterfaceattachmentsKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsNetworkInterfaceAttachment"}
...
func (c *FakeAwsNetworkInterfaceAttachments) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsNetworkInterfaceAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsnetworkinterfaceattachmentsResource, c.ns, name), &v1alpha1.AwsNetworkInterfaceAttachment{})
...
func (c *FakeAwsNetworkInterfaceAttachments) List(opts v1.ListOptions) (result *v1alpha1.AwsNetworkInterfaceAttachmentList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsnetworkinterfaceattachmentsResource, awsnetworkinterfaceattachmentsKind, c.ns, opts), &v1alpha1.AwsNetworkInterfaceAttachmentList{})
	...
	list := &v1alpha1.AwsNetworkInterfaceAttachmentList{}
...
func (c *FakeAwsNetworkInterfaceAttachments) Create(awsNetworkInterfaceAttachment *v1alpha1.AwsNetworkInterfaceAttachment) (result *v1alpha1.AwsNetworkInterfaceAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsnetworkinterfaceattachmentsResource, c.ns, awsNetworkInterfaceAttachment), &v1alpha1.AwsNetworkInterfaceAttachment{})
...
func (c *FakeAwsNetworkInterfaceAttachments) Update(awsNetworkInterfaceAttachment *v1alpha1.AwsNetworkInterfaceAttachment) (result *v1alpha1.AwsNetworkInterfaceAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsnetworkinterfaceattachmentsResource, c.ns, awsNetworkInterfaceAttachment), &v1alpha1.AwsNetworkInterfaceAttachment{})
...
func (c *FakeAwsNetworkInterfaceAttachments) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsnetworkinterfaceattachmentsResource, c.ns, name), &v1alpha1.AwsNetworkInterfaceAttachment{})
...
func (c *FakeAwsNetworkInterfaceAttachments) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsNetworkInterfaceAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsnetworkinterfaceattachmentsResource, c.ns, name, data, subresources...), &v1alpha1.AwsNetworkInterfaceAttachment{})
