...
func (c *FakeAwsLambdaEventSourceMappings) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsLambdaEventSourceMapping, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awslambdaeventsourcemappingsResource, c.ns, name), &v1alpha1.AwsLambdaEventSourceMapping{})
...
func (c *FakeAwsLambdaEventSourceMappings) List(opts v1.ListOptions) (result *v1alpha1.AwsLambdaEventSourceMappingList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awslambdaeventsourcemappingsResource, awslambdaeventsourcemappingsKind, c.ns, opts), &v1alpha1.AwsLambdaEventSourceMappingList{})
	...
	list := &v1alpha1.AwsLambdaEventSourceMappingList{}
...
func (c *FakeAwsLambdaEventSourceMappings) Create(awsLambdaEventSourceMapping *v1alpha1.AwsLambdaEventSourceMapping) (result *v1alpha1.AwsLambdaEventSourceMapping, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awslambdaeventsourcemappingsResource, c.ns, awsLambdaEventSourceMapping), &v1alpha1.AwsLambdaEventSourceMapping{})
...
func (c *FakeAwsLambdaEventSourceMappings) Update(awsLambdaEventSourceMapping *v1alpha1.AwsLambdaEventSourceMapping) (result *v1alpha1.AwsLambdaEventSourceMapping, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awslambdaeventsourcemappingsResource, c.ns, awsLambdaEventSourceMapping), &v1alpha1.AwsLambdaEventSourceMapping{})
...
func (c *FakeAwsLambdaEventSourceMappings) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awslambdaeventsourcemappingsResource, c.ns, name), &v1alpha1.AwsLambdaEventSourceMapping{})
...
func (c *FakeAwsLambdaEventSourceMappings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsLambdaEventSourceMapping, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awslambdaeventsourcemappingsResource, c.ns, name, data, subresources...), &v1alpha1.AwsLambdaEventSourceMapping{})
