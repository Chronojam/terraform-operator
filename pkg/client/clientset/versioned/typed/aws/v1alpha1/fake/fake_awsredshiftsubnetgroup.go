...
var awsredshiftsubnetgroupsResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awsredshiftsubnetgroups"}

var awsredshiftsubnetgroupsKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsRedshiftSubnetGroup"}
...
func (c *FakeAwsRedshiftSubnetGroups) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsRedshiftSubnetGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsredshiftsubnetgroupsResource, c.ns, name), &v1alpha1.AwsRedshiftSubnetGroup{})
...
func (c *FakeAwsRedshiftSubnetGroups) List(opts v1.ListOptions) (result *v1alpha1.AwsRedshiftSubnetGroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsredshiftsubnetgroupsResource, awsredshiftsubnetgroupsKind, c.ns, opts), &v1alpha1.AwsRedshiftSubnetGroupList{})
	...
	list := &v1alpha1.AwsRedshiftSubnetGroupList{}
...
func (c *FakeAwsRedshiftSubnetGroups) Create(awsRedshiftSubnetGroup *v1alpha1.AwsRedshiftSubnetGroup) (result *v1alpha1.AwsRedshiftSubnetGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsredshiftsubnetgroupsResource, c.ns, awsRedshiftSubnetGroup), &v1alpha1.AwsRedshiftSubnetGroup{})
...
func (c *FakeAwsRedshiftSubnetGroups) Update(awsRedshiftSubnetGroup *v1alpha1.AwsRedshiftSubnetGroup) (result *v1alpha1.AwsRedshiftSubnetGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsredshiftsubnetgroupsResource, c.ns, awsRedshiftSubnetGroup), &v1alpha1.AwsRedshiftSubnetGroup{})
...
func (c *FakeAwsRedshiftSubnetGroups) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsredshiftsubnetgroupsResource, c.ns, name), &v1alpha1.AwsRedshiftSubnetGroup{})
...
func (c *FakeAwsRedshiftSubnetGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsRedshiftSubnetGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsredshiftsubnetgroupsResource, c.ns, name, data, subresources...), &v1alpha1.AwsRedshiftSubnetGroup{})
