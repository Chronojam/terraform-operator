...
func (c *FakeAwsLambdaPermissions) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsLambdaPermission, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awslambdapermissionsResource, c.ns, name), &v1alpha1.AwsLambdaPermission{})
...
func (c *FakeAwsLambdaPermissions) List(opts v1.ListOptions) (result *v1alpha1.AwsLambdaPermissionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awslambdapermissionsResource, awslambdapermissionsKind, c.ns, opts), &v1alpha1.AwsLambdaPermissionList{})
	...
	list := &v1alpha1.AwsLambdaPermissionList{}
...
func (c *FakeAwsLambdaPermissions) Create(awsLambdaPermission *v1alpha1.AwsLambdaPermission) (result *v1alpha1.AwsLambdaPermission, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awslambdapermissionsResource, c.ns, awsLambdaPermission), &v1alpha1.AwsLambdaPermission{})
...
func (c *FakeAwsLambdaPermissions) Update(awsLambdaPermission *v1alpha1.AwsLambdaPermission) (result *v1alpha1.AwsLambdaPermission, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awslambdapermissionsResource, c.ns, awsLambdaPermission), &v1alpha1.AwsLambdaPermission{})
...
func (c *FakeAwsLambdaPermissions) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awslambdapermissionsResource, c.ns, name), &v1alpha1.AwsLambdaPermission{})
...
func (c *FakeAwsLambdaPermissions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsLambdaPermission, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awslambdapermissionsResource, c.ns, name, data, subresources...), &v1alpha1.AwsLambdaPermission{})
