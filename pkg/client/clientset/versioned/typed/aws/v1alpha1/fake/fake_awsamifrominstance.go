...
func (c *FakeAwsAmiFromInstances) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsAmiFromInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsamifrominstancesResource, c.ns, name), &v1alpha1.AwsAmiFromInstance{})
...
func (c *FakeAwsAmiFromInstances) List(opts v1.ListOptions) (result *v1alpha1.AwsAmiFromInstanceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsamifrominstancesResource, awsamifrominstancesKind, c.ns, opts), &v1alpha1.AwsAmiFromInstanceList{})
	...
	list := &v1alpha1.AwsAmiFromInstanceList{}
...
func (c *FakeAwsAmiFromInstances) Create(awsAmiFromInstance *v1alpha1.AwsAmiFromInstance) (result *v1alpha1.AwsAmiFromInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsamifrominstancesResource, c.ns, awsAmiFromInstance), &v1alpha1.AwsAmiFromInstance{})
...
func (c *FakeAwsAmiFromInstances) Update(awsAmiFromInstance *v1alpha1.AwsAmiFromInstance) (result *v1alpha1.AwsAmiFromInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsamifrominstancesResource, c.ns, awsAmiFromInstance), &v1alpha1.AwsAmiFromInstance{})
...
func (c *FakeAwsAmiFromInstances) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsamifrominstancesResource, c.ns, name), &v1alpha1.AwsAmiFromInstance{})
...
func (c *FakeAwsAmiFromInstances) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsAmiFromInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsamifrominstancesResource, c.ns, name, data, subresources...), &v1alpha1.AwsAmiFromInstance{})
