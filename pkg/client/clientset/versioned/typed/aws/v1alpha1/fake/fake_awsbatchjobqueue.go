...
func (c *FakeAwsBatchJobQueues) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsBatchJobQueue, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsbatchjobqueuesResource, c.ns, name), &v1alpha1.AwsBatchJobQueue{})
...
func (c *FakeAwsBatchJobQueues) List(opts v1.ListOptions) (result *v1alpha1.AwsBatchJobQueueList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsbatchjobqueuesResource, awsbatchjobqueuesKind, c.ns, opts), &v1alpha1.AwsBatchJobQueueList{})
	...
	list := &v1alpha1.AwsBatchJobQueueList{}
...
func (c *FakeAwsBatchJobQueues) Create(awsBatchJobQueue *v1alpha1.AwsBatchJobQueue) (result *v1alpha1.AwsBatchJobQueue, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsbatchjobqueuesResource, c.ns, awsBatchJobQueue), &v1alpha1.AwsBatchJobQueue{})
...
func (c *FakeAwsBatchJobQueues) Update(awsBatchJobQueue *v1alpha1.AwsBatchJobQueue) (result *v1alpha1.AwsBatchJobQueue, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsbatchjobqueuesResource, c.ns, awsBatchJobQueue), &v1alpha1.AwsBatchJobQueue{})
...
func (c *FakeAwsBatchJobQueues) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsbatchjobqueuesResource, c.ns, name), &v1alpha1.AwsBatchJobQueue{})
...
func (c *FakeAwsBatchJobQueues) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsBatchJobQueue, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsbatchjobqueuesResource, c.ns, name, data, subresources...), &v1alpha1.AwsBatchJobQueue{})
