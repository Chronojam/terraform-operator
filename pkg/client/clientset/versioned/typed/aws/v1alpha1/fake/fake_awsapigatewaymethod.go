...
var awsapigatewaymethodsResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awsapigatewaymethods"}

var awsapigatewaymethodsKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsApiGatewayMethod"}
...
func (c *FakeAwsApiGatewayMethods) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsApiGatewayMethod, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsapigatewaymethodsResource, c.ns, name), &v1alpha1.AwsApiGatewayMethod{})
...
func (c *FakeAwsApiGatewayMethods) List(opts v1.ListOptions) (result *v1alpha1.AwsApiGatewayMethodList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsapigatewaymethodsResource, awsapigatewaymethodsKind, c.ns, opts), &v1alpha1.AwsApiGatewayMethodList{})
	...
	list := &v1alpha1.AwsApiGatewayMethodList{}
...
func (c *FakeAwsApiGatewayMethods) Create(awsApiGatewayMethod *v1alpha1.AwsApiGatewayMethod) (result *v1alpha1.AwsApiGatewayMethod, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsapigatewaymethodsResource, c.ns, awsApiGatewayMethod), &v1alpha1.AwsApiGatewayMethod{})
...
func (c *FakeAwsApiGatewayMethods) Update(awsApiGatewayMethod *v1alpha1.AwsApiGatewayMethod) (result *v1alpha1.AwsApiGatewayMethod, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsapigatewaymethodsResource, c.ns, awsApiGatewayMethod), &v1alpha1.AwsApiGatewayMethod{})
...
func (c *FakeAwsApiGatewayMethods) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsapigatewaymethodsResource, c.ns, name), &v1alpha1.AwsApiGatewayMethod{})
...
func (c *FakeAwsApiGatewayMethods) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsApiGatewayMethod, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsapigatewaymethodsResource, c.ns, name, data, subresources...), &v1alpha1.AwsApiGatewayMethod{})
