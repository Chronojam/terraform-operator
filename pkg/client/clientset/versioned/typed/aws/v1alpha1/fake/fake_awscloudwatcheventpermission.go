...
func (c *FakeAwsCloudwatchEventPermissions) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsCloudwatchEventPermission, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awscloudwatcheventpermissionsResource, c.ns, name), &v1alpha1.AwsCloudwatchEventPermission{})
...
func (c *FakeAwsCloudwatchEventPermissions) List(opts v1.ListOptions) (result *v1alpha1.AwsCloudwatchEventPermissionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awscloudwatcheventpermissionsResource, awscloudwatcheventpermissionsKind, c.ns, opts), &v1alpha1.AwsCloudwatchEventPermissionList{})
	...
	list := &v1alpha1.AwsCloudwatchEventPermissionList{}
...
func (c *FakeAwsCloudwatchEventPermissions) Create(awsCloudwatchEventPermission *v1alpha1.AwsCloudwatchEventPermission) (result *v1alpha1.AwsCloudwatchEventPermission, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awscloudwatcheventpermissionsResource, c.ns, awsCloudwatchEventPermission), &v1alpha1.AwsCloudwatchEventPermission{})
...
func (c *FakeAwsCloudwatchEventPermissions) Update(awsCloudwatchEventPermission *v1alpha1.AwsCloudwatchEventPermission) (result *v1alpha1.AwsCloudwatchEventPermission, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awscloudwatcheventpermissionsResource, c.ns, awsCloudwatchEventPermission), &v1alpha1.AwsCloudwatchEventPermission{})
...
func (c *FakeAwsCloudwatchEventPermissions) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awscloudwatcheventpermissionsResource, c.ns, name), &v1alpha1.AwsCloudwatchEventPermission{})
...
func (c *FakeAwsCloudwatchEventPermissions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsCloudwatchEventPermission, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awscloudwatcheventpermissionsResource, c.ns, name, data, subresources...), &v1alpha1.AwsCloudwatchEventPermission{})
