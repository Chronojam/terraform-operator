...
var awsinternetgatewaysResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awsinternetgateways"}

var awsinternetgatewaysKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsInternetGateway"}
...
func (c *FakeAwsInternetGateways) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsInternetGateway, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsinternetgatewaysResource, c.ns, name), &v1alpha1.AwsInternetGateway{})
...
func (c *FakeAwsInternetGateways) List(opts v1.ListOptions) (result *v1alpha1.AwsInternetGatewayList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsinternetgatewaysResource, awsinternetgatewaysKind, c.ns, opts), &v1alpha1.AwsInternetGatewayList{})
	...
	list := &v1alpha1.AwsInternetGatewayList{}
...
func (c *FakeAwsInternetGateways) Create(awsInternetGateway *v1alpha1.AwsInternetGateway) (result *v1alpha1.AwsInternetGateway, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsinternetgatewaysResource, c.ns, awsInternetGateway), &v1alpha1.AwsInternetGateway{})
...
func (c *FakeAwsInternetGateways) Update(awsInternetGateway *v1alpha1.AwsInternetGateway) (result *v1alpha1.AwsInternetGateway, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsinternetgatewaysResource, c.ns, awsInternetGateway), &v1alpha1.AwsInternetGateway{})
...
func (c *FakeAwsInternetGateways) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsinternetgatewaysResource, c.ns, name), &v1alpha1.AwsInternetGateway{})
...
func (c *FakeAwsInternetGateways) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsInternetGateway, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsinternetgatewaysResource, c.ns, name, data, subresources...), &v1alpha1.AwsInternetGateway{})
