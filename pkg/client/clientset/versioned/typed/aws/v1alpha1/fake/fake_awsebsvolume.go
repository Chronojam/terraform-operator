...
func (c *FakeAwsEbsVolumes) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsEbsVolume, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsebsvolumesResource, c.ns, name), &v1alpha1.AwsEbsVolume{})
...
func (c *FakeAwsEbsVolumes) List(opts v1.ListOptions) (result *v1alpha1.AwsEbsVolumeList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsebsvolumesResource, awsebsvolumesKind, c.ns, opts), &v1alpha1.AwsEbsVolumeList{})
	...
	list := &v1alpha1.AwsEbsVolumeList{}
...
func (c *FakeAwsEbsVolumes) Create(awsEbsVolume *v1alpha1.AwsEbsVolume) (result *v1alpha1.AwsEbsVolume, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsebsvolumesResource, c.ns, awsEbsVolume), &v1alpha1.AwsEbsVolume{})
...
func (c *FakeAwsEbsVolumes) Update(awsEbsVolume *v1alpha1.AwsEbsVolume) (result *v1alpha1.AwsEbsVolume, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsebsvolumesResource, c.ns, awsEbsVolume), &v1alpha1.AwsEbsVolume{})
...
func (c *FakeAwsEbsVolumes) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsebsvolumesResource, c.ns, name), &v1alpha1.AwsEbsVolume{})
...
func (c *FakeAwsEbsVolumes) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsEbsVolume, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsebsvolumesResource, c.ns, name, data, subresources...), &v1alpha1.AwsEbsVolume{})
