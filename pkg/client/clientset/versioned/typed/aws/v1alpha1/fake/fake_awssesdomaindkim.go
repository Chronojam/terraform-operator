...
func (c *FakeAwsSesDomainDkims) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsSesDomainDkim, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awssesdomaindkimsResource, c.ns, name), &v1alpha1.AwsSesDomainDkim{})
...
func (c *FakeAwsSesDomainDkims) List(opts v1.ListOptions) (result *v1alpha1.AwsSesDomainDkimList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awssesdomaindkimsResource, awssesdomaindkimsKind, c.ns, opts), &v1alpha1.AwsSesDomainDkimList{})
	...
	list := &v1alpha1.AwsSesDomainDkimList{}
...
func (c *FakeAwsSesDomainDkims) Create(awsSesDomainDkim *v1alpha1.AwsSesDomainDkim) (result *v1alpha1.AwsSesDomainDkim, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awssesdomaindkimsResource, c.ns, awsSesDomainDkim), &v1alpha1.AwsSesDomainDkim{})
...
func (c *FakeAwsSesDomainDkims) Update(awsSesDomainDkim *v1alpha1.AwsSesDomainDkim) (result *v1alpha1.AwsSesDomainDkim, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awssesdomaindkimsResource, c.ns, awsSesDomainDkim), &v1alpha1.AwsSesDomainDkim{})
...
func (c *FakeAwsSesDomainDkims) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awssesdomaindkimsResource, c.ns, name), &v1alpha1.AwsSesDomainDkim{})
...
func (c *FakeAwsSesDomainDkims) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsSesDomainDkim, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awssesdomaindkimsResource, c.ns, name, data, subresources...), &v1alpha1.AwsSesDomainDkim{})
