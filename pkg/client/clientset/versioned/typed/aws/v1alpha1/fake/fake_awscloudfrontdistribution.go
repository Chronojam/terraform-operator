...
func (c *FakeAwsCloudfrontDistributions) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsCloudfrontDistribution, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awscloudfrontdistributionsResource, c.ns, name), &v1alpha1.AwsCloudfrontDistribution{})
...
func (c *FakeAwsCloudfrontDistributions) List(opts v1.ListOptions) (result *v1alpha1.AwsCloudfrontDistributionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awscloudfrontdistributionsResource, awscloudfrontdistributionsKind, c.ns, opts), &v1alpha1.AwsCloudfrontDistributionList{})
	...
	list := &v1alpha1.AwsCloudfrontDistributionList{}
...
func (c *FakeAwsCloudfrontDistributions) Create(awsCloudfrontDistribution *v1alpha1.AwsCloudfrontDistribution) (result *v1alpha1.AwsCloudfrontDistribution, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awscloudfrontdistributionsResource, c.ns, awsCloudfrontDistribution), &v1alpha1.AwsCloudfrontDistribution{})
...
func (c *FakeAwsCloudfrontDistributions) Update(awsCloudfrontDistribution *v1alpha1.AwsCloudfrontDistribution) (result *v1alpha1.AwsCloudfrontDistribution, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awscloudfrontdistributionsResource, c.ns, awsCloudfrontDistribution), &v1alpha1.AwsCloudfrontDistribution{})
...
func (c *FakeAwsCloudfrontDistributions) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awscloudfrontdistributionsResource, c.ns, name), &v1alpha1.AwsCloudfrontDistribution{})
...
func (c *FakeAwsCloudfrontDistributions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsCloudfrontDistribution, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awscloudfrontdistributionsResource, c.ns, name, data, subresources...), &v1alpha1.AwsCloudfrontDistribution{})
