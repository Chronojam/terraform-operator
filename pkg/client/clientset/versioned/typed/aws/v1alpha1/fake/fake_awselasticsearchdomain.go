...
var awselasticsearchdomainsResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awselasticsearchdomains"}

var awselasticsearchdomainsKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsElasticsearchDomain"}
...
func (c *FakeAwsElasticsearchDomains) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsElasticsearchDomain, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awselasticsearchdomainsResource, c.ns, name), &v1alpha1.AwsElasticsearchDomain{})
...
func (c *FakeAwsElasticsearchDomains) List(opts v1.ListOptions) (result *v1alpha1.AwsElasticsearchDomainList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awselasticsearchdomainsResource, awselasticsearchdomainsKind, c.ns, opts), &v1alpha1.AwsElasticsearchDomainList{})
	...
	list := &v1alpha1.AwsElasticsearchDomainList{}
...
func (c *FakeAwsElasticsearchDomains) Create(awsElasticsearchDomain *v1alpha1.AwsElasticsearchDomain) (result *v1alpha1.AwsElasticsearchDomain, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awselasticsearchdomainsResource, c.ns, awsElasticsearchDomain), &v1alpha1.AwsElasticsearchDomain{})
...
func (c *FakeAwsElasticsearchDomains) Update(awsElasticsearchDomain *v1alpha1.AwsElasticsearchDomain) (result *v1alpha1.AwsElasticsearchDomain, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awselasticsearchdomainsResource, c.ns, awsElasticsearchDomain), &v1alpha1.AwsElasticsearchDomain{})
...
func (c *FakeAwsElasticsearchDomains) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awselasticsearchdomainsResource, c.ns, name), &v1alpha1.AwsElasticsearchDomain{})
...
func (c *FakeAwsElasticsearchDomains) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsElasticsearchDomain, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awselasticsearchdomainsResource, c.ns, name, data, subresources...), &v1alpha1.AwsElasticsearchDomain{})
