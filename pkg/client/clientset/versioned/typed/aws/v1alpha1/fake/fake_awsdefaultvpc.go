...
func (c *FakeAwsDefaultVpcs) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsDefaultVpc, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsdefaultvpcsResource, c.ns, name), &v1alpha1.AwsDefaultVpc{})
...
func (c *FakeAwsDefaultVpcs) List(opts v1.ListOptions) (result *v1alpha1.AwsDefaultVpcList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsdefaultvpcsResource, awsdefaultvpcsKind, c.ns, opts), &v1alpha1.AwsDefaultVpcList{})
	...
	list := &v1alpha1.AwsDefaultVpcList{}
...
func (c *FakeAwsDefaultVpcs) Create(awsDefaultVpc *v1alpha1.AwsDefaultVpc) (result *v1alpha1.AwsDefaultVpc, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsdefaultvpcsResource, c.ns, awsDefaultVpc), &v1alpha1.AwsDefaultVpc{})
...
func (c *FakeAwsDefaultVpcs) Update(awsDefaultVpc *v1alpha1.AwsDefaultVpc) (result *v1alpha1.AwsDefaultVpc, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsdefaultvpcsResource, c.ns, awsDefaultVpc), &v1alpha1.AwsDefaultVpc{})
...
func (c *FakeAwsDefaultVpcs) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsdefaultvpcsResource, c.ns, name), &v1alpha1.AwsDefaultVpc{})
...
func (c *FakeAwsDefaultVpcs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsDefaultVpc, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsdefaultvpcsResource, c.ns, name, data, subresources...), &v1alpha1.AwsDefaultVpc{})
