...
func (c *FakeAwsSnsTopics) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsSnsTopic, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awssnstopicsResource, c.ns, name), &v1alpha1.AwsSnsTopic{})
...
func (c *FakeAwsSnsTopics) List(opts v1.ListOptions) (result *v1alpha1.AwsSnsTopicList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awssnstopicsResource, awssnstopicsKind, c.ns, opts), &v1alpha1.AwsSnsTopicList{})
...
func (c *FakeAwsSnsTopics) Create(awsSnsTopic *v1alpha1.AwsSnsTopic) (result *v1alpha1.AwsSnsTopic, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awssnstopicsResource, c.ns, awsSnsTopic), &v1alpha1.AwsSnsTopic{})
...
func (c *FakeAwsSnsTopics) Update(awsSnsTopic *v1alpha1.AwsSnsTopic) (result *v1alpha1.AwsSnsTopic, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awssnstopicsResource, c.ns, awsSnsTopic), &v1alpha1.AwsSnsTopic{})
...
func (c *FakeAwsSnsTopics) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awssnstopicsResource, c.ns, name), &v1alpha1.AwsSnsTopic{})
...
func (c *FakeAwsSnsTopics) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsSnsTopic, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awssnstopicsResource, c.ns, name, data, subresources...), &v1alpha1.AwsSnsTopic{})
