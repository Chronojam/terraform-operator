...
func (c *FakeAwsElasticBeanstalkApplications) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsElasticBeanstalkApplication, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awselasticbeanstalkapplicationsResource, c.ns, name), &v1alpha1.AwsElasticBeanstalkApplication{})
...
func (c *FakeAwsElasticBeanstalkApplications) List(opts v1.ListOptions) (result *v1alpha1.AwsElasticBeanstalkApplicationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awselasticbeanstalkapplicationsResource, awselasticbeanstalkapplicationsKind, c.ns, opts), &v1alpha1.AwsElasticBeanstalkApplicationList{})
	...
	list := &v1alpha1.AwsElasticBeanstalkApplicationList{}
...
func (c *FakeAwsElasticBeanstalkApplications) Create(awsElasticBeanstalkApplication *v1alpha1.AwsElasticBeanstalkApplication) (result *v1alpha1.AwsElasticBeanstalkApplication, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awselasticbeanstalkapplicationsResource, c.ns, awsElasticBeanstalkApplication), &v1alpha1.AwsElasticBeanstalkApplication{})
...
func (c *FakeAwsElasticBeanstalkApplications) Update(awsElasticBeanstalkApplication *v1alpha1.AwsElasticBeanstalkApplication) (result *v1alpha1.AwsElasticBeanstalkApplication, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awselasticbeanstalkapplicationsResource, c.ns, awsElasticBeanstalkApplication), &v1alpha1.AwsElasticBeanstalkApplication{})
...
func (c *FakeAwsElasticBeanstalkApplications) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awselasticbeanstalkapplicationsResource, c.ns, name), &v1alpha1.AwsElasticBeanstalkApplication{})
...
func (c *FakeAwsElasticBeanstalkApplications) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsElasticBeanstalkApplication, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awselasticbeanstalkapplicationsResource, c.ns, name, data, subresources...), &v1alpha1.AwsElasticBeanstalkApplication{})
