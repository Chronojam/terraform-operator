...
func (c *FakeAwsIamGroups) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsIamGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsiamgroupsResource, c.ns, name), &v1alpha1.AwsIamGroup{})
...
func (c *FakeAwsIamGroups) List(opts v1.ListOptions) (result *v1alpha1.AwsIamGroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsiamgroupsResource, awsiamgroupsKind, c.ns, opts), &v1alpha1.AwsIamGroupList{})
...
func (c *FakeAwsIamGroups) Create(awsIamGroup *v1alpha1.AwsIamGroup) (result *v1alpha1.AwsIamGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsiamgroupsResource, c.ns, awsIamGroup), &v1alpha1.AwsIamGroup{})
...
func (c *FakeAwsIamGroups) Update(awsIamGroup *v1alpha1.AwsIamGroup) (result *v1alpha1.AwsIamGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsiamgroupsResource, c.ns, awsIamGroup), &v1alpha1.AwsIamGroup{})
...
func (c *FakeAwsIamGroups) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsiamgroupsResource, c.ns, name), &v1alpha1.AwsIamGroup{})
...
func (c *FakeAwsIamGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsIamGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsiamgroupsResource, c.ns, name, data, subresources...), &v1alpha1.AwsIamGroup{})
