...
var awsiaminstanceprofilesResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awsiaminstanceprofiles"}

var awsiaminstanceprofilesKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsIamInstanceProfile"}
...
func (c *FakeAwsIamInstanceProfiles) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsIamInstanceProfile, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsiaminstanceprofilesResource, c.ns, name), &v1alpha1.AwsIamInstanceProfile{})
...
func (c *FakeAwsIamInstanceProfiles) List(opts v1.ListOptions) (result *v1alpha1.AwsIamInstanceProfileList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsiaminstanceprofilesResource, awsiaminstanceprofilesKind, c.ns, opts), &v1alpha1.AwsIamInstanceProfileList{})
	...
	list := &v1alpha1.AwsIamInstanceProfileList{}
...
func (c *FakeAwsIamInstanceProfiles) Create(awsIamInstanceProfile *v1alpha1.AwsIamInstanceProfile) (result *v1alpha1.AwsIamInstanceProfile, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsiaminstanceprofilesResource, c.ns, awsIamInstanceProfile), &v1alpha1.AwsIamInstanceProfile{})
...
func (c *FakeAwsIamInstanceProfiles) Update(awsIamInstanceProfile *v1alpha1.AwsIamInstanceProfile) (result *v1alpha1.AwsIamInstanceProfile, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsiaminstanceprofilesResource, c.ns, awsIamInstanceProfile), &v1alpha1.AwsIamInstanceProfile{})
...
func (c *FakeAwsIamInstanceProfiles) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsiaminstanceprofilesResource, c.ns, name), &v1alpha1.AwsIamInstanceProfile{})
...
func (c *FakeAwsIamInstanceProfiles) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsIamInstanceProfile, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsiaminstanceprofilesResource, c.ns, name, data, subresources...), &v1alpha1.AwsIamInstanceProfile{})
