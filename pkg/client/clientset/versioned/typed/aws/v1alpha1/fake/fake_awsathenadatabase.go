...
func (c *FakeAwsAthenaDatabases) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsAthenaDatabase, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsathenadatabasesResource, c.ns, name), &v1alpha1.AwsAthenaDatabase{})
...
func (c *FakeAwsAthenaDatabases) List(opts v1.ListOptions) (result *v1alpha1.AwsAthenaDatabaseList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsathenadatabasesResource, awsathenadatabasesKind, c.ns, opts), &v1alpha1.AwsAthenaDatabaseList{})
	...
	list := &v1alpha1.AwsAthenaDatabaseList{}
...
func (c *FakeAwsAthenaDatabases) Create(awsAthenaDatabase *v1alpha1.AwsAthenaDatabase) (result *v1alpha1.AwsAthenaDatabase, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsathenadatabasesResource, c.ns, awsAthenaDatabase), &v1alpha1.AwsAthenaDatabase{})
...
func (c *FakeAwsAthenaDatabases) Update(awsAthenaDatabase *v1alpha1.AwsAthenaDatabase) (result *v1alpha1.AwsAthenaDatabase, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsathenadatabasesResource, c.ns, awsAthenaDatabase), &v1alpha1.AwsAthenaDatabase{})
...
func (c *FakeAwsAthenaDatabases) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsathenadatabasesResource, c.ns, name), &v1alpha1.AwsAthenaDatabase{})
...
func (c *FakeAwsAthenaDatabases) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsAthenaDatabase, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsathenadatabasesResource, c.ns, name, data, subresources...), &v1alpha1.AwsAthenaDatabase{})
