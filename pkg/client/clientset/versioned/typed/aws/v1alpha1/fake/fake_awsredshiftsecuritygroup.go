...
func (c *FakeAwsRedshiftSecurityGroups) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsRedshiftSecurityGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsredshiftsecuritygroupsResource, c.ns, name), &v1alpha1.AwsRedshiftSecurityGroup{})
...
func (c *FakeAwsRedshiftSecurityGroups) List(opts v1.ListOptions) (result *v1alpha1.AwsRedshiftSecurityGroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsredshiftsecuritygroupsResource, awsredshiftsecuritygroupsKind, c.ns, opts), &v1alpha1.AwsRedshiftSecurityGroupList{})
	...
	list := &v1alpha1.AwsRedshiftSecurityGroupList{}
...
func (c *FakeAwsRedshiftSecurityGroups) Create(awsRedshiftSecurityGroup *v1alpha1.AwsRedshiftSecurityGroup) (result *v1alpha1.AwsRedshiftSecurityGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsredshiftsecuritygroupsResource, c.ns, awsRedshiftSecurityGroup), &v1alpha1.AwsRedshiftSecurityGroup{})
...
func (c *FakeAwsRedshiftSecurityGroups) Update(awsRedshiftSecurityGroup *v1alpha1.AwsRedshiftSecurityGroup) (result *v1alpha1.AwsRedshiftSecurityGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsredshiftsecuritygroupsResource, c.ns, awsRedshiftSecurityGroup), &v1alpha1.AwsRedshiftSecurityGroup{})
...
func (c *FakeAwsRedshiftSecurityGroups) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsredshiftsecuritygroupsResource, c.ns, name), &v1alpha1.AwsRedshiftSecurityGroup{})
...
func (c *FakeAwsRedshiftSecurityGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsRedshiftSecurityGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsredshiftsecuritygroupsResource, c.ns, name, data, subresources...), &v1alpha1.AwsRedshiftSecurityGroup{})
