...
func (c *FakeAwsIamRoles) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsIamRole, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsiamrolesResource, c.ns, name), &v1alpha1.AwsIamRole{})
...
func (c *FakeAwsIamRoles) List(opts v1.ListOptions) (result *v1alpha1.AwsIamRoleList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsiamrolesResource, awsiamrolesKind, c.ns, opts), &v1alpha1.AwsIamRoleList{})
...
func (c *FakeAwsIamRoles) Create(awsIamRole *v1alpha1.AwsIamRole) (result *v1alpha1.AwsIamRole, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsiamrolesResource, c.ns, awsIamRole), &v1alpha1.AwsIamRole{})
...
func (c *FakeAwsIamRoles) Update(awsIamRole *v1alpha1.AwsIamRole) (result *v1alpha1.AwsIamRole, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsiamrolesResource, c.ns, awsIamRole), &v1alpha1.AwsIamRole{})
...
func (c *FakeAwsIamRoles) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsiamrolesResource, c.ns, name), &v1alpha1.AwsIamRole{})
...
func (c *FakeAwsIamRoles) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsIamRole, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsiamrolesResource, c.ns, name, data, subresources...), &v1alpha1.AwsIamRole{})
