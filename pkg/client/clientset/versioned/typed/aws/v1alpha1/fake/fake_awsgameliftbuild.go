...
func (c *FakeAwsGameliftBuilds) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsGameliftBuild, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsgameliftbuildsResource, c.ns, name), &v1alpha1.AwsGameliftBuild{})
...
func (c *FakeAwsGameliftBuilds) List(opts v1.ListOptions) (result *v1alpha1.AwsGameliftBuildList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsgameliftbuildsResource, awsgameliftbuildsKind, c.ns, opts), &v1alpha1.AwsGameliftBuildList{})
	...
	list := &v1alpha1.AwsGameliftBuildList{}
...
func (c *FakeAwsGameliftBuilds) Create(awsGameliftBuild *v1alpha1.AwsGameliftBuild) (result *v1alpha1.AwsGameliftBuild, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsgameliftbuildsResource, c.ns, awsGameliftBuild), &v1alpha1.AwsGameliftBuild{})
...
func (c *FakeAwsGameliftBuilds) Update(awsGameliftBuild *v1alpha1.AwsGameliftBuild) (result *v1alpha1.AwsGameliftBuild, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsgameliftbuildsResource, c.ns, awsGameliftBuild), &v1alpha1.AwsGameliftBuild{})
...
func (c *FakeAwsGameliftBuilds) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsgameliftbuildsResource, c.ns, name), &v1alpha1.AwsGameliftBuild{})
...
func (c *FakeAwsGameliftBuilds) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsGameliftBuild, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsgameliftbuildsResource, c.ns, name, data, subresources...), &v1alpha1.AwsGameliftBuild{})
