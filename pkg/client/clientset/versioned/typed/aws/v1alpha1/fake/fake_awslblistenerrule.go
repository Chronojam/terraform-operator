...
func (c *FakeAwsLbListenerRules) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsLbListenerRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awslblistenerrulesResource, c.ns, name), &v1alpha1.AwsLbListenerRule{})
...
func (c *FakeAwsLbListenerRules) List(opts v1.ListOptions) (result *v1alpha1.AwsLbListenerRuleList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awslblistenerrulesResource, awslblistenerrulesKind, c.ns, opts), &v1alpha1.AwsLbListenerRuleList{})
	...
	list := &v1alpha1.AwsLbListenerRuleList{}
...
func (c *FakeAwsLbListenerRules) Create(awsLbListenerRule *v1alpha1.AwsLbListenerRule) (result *v1alpha1.AwsLbListenerRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awslblistenerrulesResource, c.ns, awsLbListenerRule), &v1alpha1.AwsLbListenerRule{})
...
func (c *FakeAwsLbListenerRules) Update(awsLbListenerRule *v1alpha1.AwsLbListenerRule) (result *v1alpha1.AwsLbListenerRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awslblistenerrulesResource, c.ns, awsLbListenerRule), &v1alpha1.AwsLbListenerRule{})
...
func (c *FakeAwsLbListenerRules) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awslblistenerrulesResource, c.ns, name), &v1alpha1.AwsLbListenerRule{})
...
func (c *FakeAwsLbListenerRules) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsLbListenerRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awslblistenerrulesResource, c.ns, name, data, subresources...), &v1alpha1.AwsLbListenerRule{})
