...
var awsvpcendpointservicesResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awsvpcendpointservices"}

var awsvpcendpointservicesKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsVpcEndpointService"}
...
func (c *FakeAwsVpcEndpointServices) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsVpcEndpointService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsvpcendpointservicesResource, c.ns, name), &v1alpha1.AwsVpcEndpointService{})
...
func (c *FakeAwsVpcEndpointServices) List(opts v1.ListOptions) (result *v1alpha1.AwsVpcEndpointServiceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsvpcendpointservicesResource, awsvpcendpointservicesKind, c.ns, opts), &v1alpha1.AwsVpcEndpointServiceList{})
	...
	list := &v1alpha1.AwsVpcEndpointServiceList{}
...
func (c *FakeAwsVpcEndpointServices) Create(awsVpcEndpointService *v1alpha1.AwsVpcEndpointService) (result *v1alpha1.AwsVpcEndpointService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsvpcendpointservicesResource, c.ns, awsVpcEndpointService), &v1alpha1.AwsVpcEndpointService{})
...
func (c *FakeAwsVpcEndpointServices) Update(awsVpcEndpointService *v1alpha1.AwsVpcEndpointService) (result *v1alpha1.AwsVpcEndpointService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsvpcendpointservicesResource, c.ns, awsVpcEndpointService), &v1alpha1.AwsVpcEndpointService{})
...
func (c *FakeAwsVpcEndpointServices) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsvpcendpointservicesResource, c.ns, name), &v1alpha1.AwsVpcEndpointService{})
...
func (c *FakeAwsVpcEndpointServices) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsVpcEndpointService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsvpcendpointservicesResource, c.ns, name, data, subresources...), &v1alpha1.AwsVpcEndpointService{})
