...
var awswafwebaclsResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awswafwebacls"}

var awswafwebaclsKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsWafWebAcl"}
...
func (c *FakeAwsWafWebAcls) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsWafWebAcl, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awswafwebaclsResource, c.ns, name), &v1alpha1.AwsWafWebAcl{})
...
func (c *FakeAwsWafWebAcls) List(opts v1.ListOptions) (result *v1alpha1.AwsWafWebAclList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awswafwebaclsResource, awswafwebaclsKind, c.ns, opts), &v1alpha1.AwsWafWebAclList{})
	...
	list := &v1alpha1.AwsWafWebAclList{}
...
func (c *FakeAwsWafWebAcls) Create(awsWafWebAcl *v1alpha1.AwsWafWebAcl) (result *v1alpha1.AwsWafWebAcl, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awswafwebaclsResource, c.ns, awsWafWebAcl), &v1alpha1.AwsWafWebAcl{})
...
func (c *FakeAwsWafWebAcls) Update(awsWafWebAcl *v1alpha1.AwsWafWebAcl) (result *v1alpha1.AwsWafWebAcl, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awswafwebaclsResource, c.ns, awsWafWebAcl), &v1alpha1.AwsWafWebAcl{})
...
func (c *FakeAwsWafWebAcls) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awswafwebaclsResource, c.ns, name), &v1alpha1.AwsWafWebAcl{})
...
func (c *FakeAwsWafWebAcls) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsWafWebAcl, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awswafwebaclsResource, c.ns, name, data, subresources...), &v1alpha1.AwsWafWebAcl{})
