...
var awswafwebaclsResource = schema.GroupVersionResource{Group: "aws", Version: "v1alpha1", Resource: "awswafwebacls"}

var awswafwebaclsKind = schema.GroupVersionKind{Group: "aws", Version: "v1alpha1", Kind: "AwsWafWebAcl"}
