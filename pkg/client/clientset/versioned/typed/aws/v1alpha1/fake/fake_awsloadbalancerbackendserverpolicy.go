...
var awsloadbalancerbackendserverpoliciesResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awsloadbalancerbackendserverpolicies"}

var awsloadbalancerbackendserverpoliciesKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsLoadBalancerBackendServerPolicy"}
...
func (c *FakeAwsLoadBalancerBackendServerPolicies) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsLoadBalancerBackendServerPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsloadbalancerbackendserverpoliciesResource, c.ns, name), &v1alpha1.AwsLoadBalancerBackendServerPolicy{})
...
func (c *FakeAwsLoadBalancerBackendServerPolicies) List(opts v1.ListOptions) (result *v1alpha1.AwsLoadBalancerBackendServerPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsloadbalancerbackendserverpoliciesResource, awsloadbalancerbackendserverpoliciesKind, c.ns, opts), &v1alpha1.AwsLoadBalancerBackendServerPolicyList{})
	...
	list := &v1alpha1.AwsLoadBalancerBackendServerPolicyList{}
...
func (c *FakeAwsLoadBalancerBackendServerPolicies) Create(awsLoadBalancerBackendServerPolicy *v1alpha1.AwsLoadBalancerBackendServerPolicy) (result *v1alpha1.AwsLoadBalancerBackendServerPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsloadbalancerbackendserverpoliciesResource, c.ns, awsLoadBalancerBackendServerPolicy), &v1alpha1.AwsLoadBalancerBackendServerPolicy{})
...
func (c *FakeAwsLoadBalancerBackendServerPolicies) Update(awsLoadBalancerBackendServerPolicy *v1alpha1.AwsLoadBalancerBackendServerPolicy) (result *v1alpha1.AwsLoadBalancerBackendServerPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsloadbalancerbackendserverpoliciesResource, c.ns, awsLoadBalancerBackendServerPolicy), &v1alpha1.AwsLoadBalancerBackendServerPolicy{})
...
func (c *FakeAwsLoadBalancerBackendServerPolicies) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsloadbalancerbackendserverpoliciesResource, c.ns, name), &v1alpha1.AwsLoadBalancerBackendServerPolicy{})
...
func (c *FakeAwsLoadBalancerBackendServerPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsLoadBalancerBackendServerPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsloadbalancerbackendserverpoliciesResource, c.ns, name, data, subresources...), &v1alpha1.AwsLoadBalancerBackendServerPolicy{})
