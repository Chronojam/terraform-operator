...
func (c *FakeAwsLbListenerCertificates) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsLbListenerCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awslblistenercertificatesResource, c.ns, name), &v1alpha1.AwsLbListenerCertificate{})
...
func (c *FakeAwsLbListenerCertificates) List(opts v1.ListOptions) (result *v1alpha1.AwsLbListenerCertificateList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awslblistenercertificatesResource, awslblistenercertificatesKind, c.ns, opts), &v1alpha1.AwsLbListenerCertificateList{})
	...
	list := &v1alpha1.AwsLbListenerCertificateList{}
...
func (c *FakeAwsLbListenerCertificates) Create(awsLbListenerCertificate *v1alpha1.AwsLbListenerCertificate) (result *v1alpha1.AwsLbListenerCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awslblistenercertificatesResource, c.ns, awsLbListenerCertificate), &v1alpha1.AwsLbListenerCertificate{})
...
func (c *FakeAwsLbListenerCertificates) Update(awsLbListenerCertificate *v1alpha1.AwsLbListenerCertificate) (result *v1alpha1.AwsLbListenerCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awslblistenercertificatesResource, c.ns, awsLbListenerCertificate), &v1alpha1.AwsLbListenerCertificate{})
...
func (c *FakeAwsLbListenerCertificates) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awslblistenercertificatesResource, c.ns, name), &v1alpha1.AwsLbListenerCertificate{})
...
func (c *FakeAwsLbListenerCertificates) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsLbListenerCertificate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awslblistenercertificatesResource, c.ns, name, data, subresources...), &v1alpha1.AwsLbListenerCertificate{})
