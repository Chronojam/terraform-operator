...
func (c *FakeAwsGlueCatalogDatabases) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsGlueCatalogDatabase, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsgluecatalogdatabasesResource, c.ns, name), &v1alpha1.AwsGlueCatalogDatabase{})
...
func (c *FakeAwsGlueCatalogDatabases) List(opts v1.ListOptions) (result *v1alpha1.AwsGlueCatalogDatabaseList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsgluecatalogdatabasesResource, awsgluecatalogdatabasesKind, c.ns, opts), &v1alpha1.AwsGlueCatalogDatabaseList{})
	...
	list := &v1alpha1.AwsGlueCatalogDatabaseList{}
...
func (c *FakeAwsGlueCatalogDatabases) Create(awsGlueCatalogDatabase *v1alpha1.AwsGlueCatalogDatabase) (result *v1alpha1.AwsGlueCatalogDatabase, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsgluecatalogdatabasesResource, c.ns, awsGlueCatalogDatabase), &v1alpha1.AwsGlueCatalogDatabase{})
...
func (c *FakeAwsGlueCatalogDatabases) Update(awsGlueCatalogDatabase *v1alpha1.AwsGlueCatalogDatabase) (result *v1alpha1.AwsGlueCatalogDatabase, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsgluecatalogdatabasesResource, c.ns, awsGlueCatalogDatabase), &v1alpha1.AwsGlueCatalogDatabase{})
...
func (c *FakeAwsGlueCatalogDatabases) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsgluecatalogdatabasesResource, c.ns, name), &v1alpha1.AwsGlueCatalogDatabase{})
...
func (c *FakeAwsGlueCatalogDatabases) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsGlueCatalogDatabase, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsgluecatalogdatabasesResource, c.ns, name, data, subresources...), &v1alpha1.AwsGlueCatalogDatabase{})
