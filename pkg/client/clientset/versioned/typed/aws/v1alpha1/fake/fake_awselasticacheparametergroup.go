...
func (c *FakeAwsElasticacheParameterGroups) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsElasticacheParameterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awselasticacheparametergroupsResource, c.ns, name), &v1alpha1.AwsElasticacheParameterGroup{})
...
func (c *FakeAwsElasticacheParameterGroups) List(opts v1.ListOptions) (result *v1alpha1.AwsElasticacheParameterGroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awselasticacheparametergroupsResource, awselasticacheparametergroupsKind, c.ns, opts), &v1alpha1.AwsElasticacheParameterGroupList{})
	...
	list := &v1alpha1.AwsElasticacheParameterGroupList{}
...
func (c *FakeAwsElasticacheParameterGroups) Create(awsElasticacheParameterGroup *v1alpha1.AwsElasticacheParameterGroup) (result *v1alpha1.AwsElasticacheParameterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awselasticacheparametergroupsResource, c.ns, awsElasticacheParameterGroup), &v1alpha1.AwsElasticacheParameterGroup{})
...
func (c *FakeAwsElasticacheParameterGroups) Update(awsElasticacheParameterGroup *v1alpha1.AwsElasticacheParameterGroup) (result *v1alpha1.AwsElasticacheParameterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awselasticacheparametergroupsResource, c.ns, awsElasticacheParameterGroup), &v1alpha1.AwsElasticacheParameterGroup{})
...
func (c *FakeAwsElasticacheParameterGroups) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awselasticacheparametergroupsResource, c.ns, name), &v1alpha1.AwsElasticacheParameterGroup{})
...
func (c *FakeAwsElasticacheParameterGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsElasticacheParameterGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awselasticacheparametergroupsResource, c.ns, name, data, subresources...), &v1alpha1.AwsElasticacheParameterGroup{})
