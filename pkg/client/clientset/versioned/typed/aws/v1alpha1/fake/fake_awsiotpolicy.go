...
func (c *FakeAwsIotPolicies) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsIotPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsiotpoliciesResource, c.ns, name), &v1alpha1.AwsIotPolicy{})
...
func (c *FakeAwsIotPolicies) List(opts v1.ListOptions) (result *v1alpha1.AwsIotPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsiotpoliciesResource, awsiotpoliciesKind, c.ns, opts), &v1alpha1.AwsIotPolicyList{})
	...
	list := &v1alpha1.AwsIotPolicyList{}
...
func (c *FakeAwsIotPolicies) Create(awsIotPolicy *v1alpha1.AwsIotPolicy) (result *v1alpha1.AwsIotPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsiotpoliciesResource, c.ns, awsIotPolicy), &v1alpha1.AwsIotPolicy{})
...
func (c *FakeAwsIotPolicies) Update(awsIotPolicy *v1alpha1.AwsIotPolicy) (result *v1alpha1.AwsIotPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsiotpoliciesResource, c.ns, awsIotPolicy), &v1alpha1.AwsIotPolicy{})
...
func (c *FakeAwsIotPolicies) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsiotpoliciesResource, c.ns, name), &v1alpha1.AwsIotPolicy{})
...
func (c *FakeAwsIotPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsIotPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsiotpoliciesResource, c.ns, name, data, subresources...), &v1alpha1.AwsIotPolicy{})
