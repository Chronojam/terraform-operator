...
var awssecuritygroupsResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awssecuritygroups"}

var awssecuritygroupsKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsSecurityGroup"}
...
func (c *FakeAwsSecurityGroups) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsSecurityGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awssecuritygroupsResource, c.ns, name), &v1alpha1.AwsSecurityGroup{})
...
func (c *FakeAwsSecurityGroups) List(opts v1.ListOptions) (result *v1alpha1.AwsSecurityGroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awssecuritygroupsResource, awssecuritygroupsKind, c.ns, opts), &v1alpha1.AwsSecurityGroupList{})
	...
	list := &v1alpha1.AwsSecurityGroupList{}
...
func (c *FakeAwsSecurityGroups) Create(awsSecurityGroup *v1alpha1.AwsSecurityGroup) (result *v1alpha1.AwsSecurityGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awssecuritygroupsResource, c.ns, awsSecurityGroup), &v1alpha1.AwsSecurityGroup{})
...
func (c *FakeAwsSecurityGroups) Update(awsSecurityGroup *v1alpha1.AwsSecurityGroup) (result *v1alpha1.AwsSecurityGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awssecuritygroupsResource, c.ns, awsSecurityGroup), &v1alpha1.AwsSecurityGroup{})
...
func (c *FakeAwsSecurityGroups) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awssecuritygroupsResource, c.ns, name), &v1alpha1.AwsSecurityGroup{})
...
func (c *FakeAwsSecurityGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsSecurityGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awssecuritygroupsResource, c.ns, name, data, subresources...), &v1alpha1.AwsSecurityGroup{})
