...
func (c *FakeAwsOpsworksUserProfiles) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsOpsworksUserProfile, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsopsworksuserprofilesResource, c.ns, name), &v1alpha1.AwsOpsworksUserProfile{})
...
func (c *FakeAwsOpsworksUserProfiles) List(opts v1.ListOptions) (result *v1alpha1.AwsOpsworksUserProfileList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsopsworksuserprofilesResource, awsopsworksuserprofilesKind, c.ns, opts), &v1alpha1.AwsOpsworksUserProfileList{})
	...
	list := &v1alpha1.AwsOpsworksUserProfileList{}
...
func (c *FakeAwsOpsworksUserProfiles) Create(awsOpsworksUserProfile *v1alpha1.AwsOpsworksUserProfile) (result *v1alpha1.AwsOpsworksUserProfile, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsopsworksuserprofilesResource, c.ns, awsOpsworksUserProfile), &v1alpha1.AwsOpsworksUserProfile{})
...
func (c *FakeAwsOpsworksUserProfiles) Update(awsOpsworksUserProfile *v1alpha1.AwsOpsworksUserProfile) (result *v1alpha1.AwsOpsworksUserProfile, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsopsworksuserprofilesResource, c.ns, awsOpsworksUserProfile), &v1alpha1.AwsOpsworksUserProfile{})
...
func (c *FakeAwsOpsworksUserProfiles) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsopsworksuserprofilesResource, c.ns, name), &v1alpha1.AwsOpsworksUserProfile{})
...
func (c *FakeAwsOpsworksUserProfiles) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsOpsworksUserProfile, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsopsworksuserprofilesResource, c.ns, name, data, subresources...), &v1alpha1.AwsOpsworksUserProfile{})
