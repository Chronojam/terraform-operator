...
var awslambdaaliasesResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awslambdaaliases"}

var awslambdaaliasesKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsLambdaAlias"}
...
func (c *FakeAwsLambdaAliases) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsLambdaAlias, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awslambdaaliasesResource, c.ns, name), &v1alpha1.AwsLambdaAlias{})
...
func (c *FakeAwsLambdaAliases) List(opts v1.ListOptions) (result *v1alpha1.AwsLambdaAliasList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awslambdaaliasesResource, awslambdaaliasesKind, c.ns, opts), &v1alpha1.AwsLambdaAliasList{})
	...
	list := &v1alpha1.AwsLambdaAliasList{}
...
func (c *FakeAwsLambdaAliases) Create(awsLambdaAlias *v1alpha1.AwsLambdaAlias) (result *v1alpha1.AwsLambdaAlias, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awslambdaaliasesResource, c.ns, awsLambdaAlias), &v1alpha1.AwsLambdaAlias{})
...
func (c *FakeAwsLambdaAliases) Update(awsLambdaAlias *v1alpha1.AwsLambdaAlias) (result *v1alpha1.AwsLambdaAlias, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awslambdaaliasesResource, c.ns, awsLambdaAlias), &v1alpha1.AwsLambdaAlias{})
...
func (c *FakeAwsLambdaAliases) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awslambdaaliasesResource, c.ns, name), &v1alpha1.AwsLambdaAlias{})
...
func (c *FakeAwsLambdaAliases) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsLambdaAlias, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awslambdaaliasesResource, c.ns, name, data, subresources...), &v1alpha1.AwsLambdaAlias{})
