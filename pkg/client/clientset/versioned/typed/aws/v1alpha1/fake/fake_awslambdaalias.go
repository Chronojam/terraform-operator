...
var awslambdaaliasesResource = schema.GroupVersionResource{Group: "aws", Version: "v1alpha1", Resource: "awslambdaaliases"}

var awslambdaaliasesKind = schema.GroupVersionKind{Group: "aws", Version: "v1alpha1", Kind: "AwsLambdaAlias"}
