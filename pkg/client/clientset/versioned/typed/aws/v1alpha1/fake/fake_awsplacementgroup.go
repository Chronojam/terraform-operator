...
func (c *FakeAwsPlacementGroups) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsPlacementGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsplacementgroupsResource, c.ns, name), &v1alpha1.AwsPlacementGroup{})
...
func (c *FakeAwsPlacementGroups) List(opts v1.ListOptions) (result *v1alpha1.AwsPlacementGroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsplacementgroupsResource, awsplacementgroupsKind, c.ns, opts), &v1alpha1.AwsPlacementGroupList{})
	...
	list := &v1alpha1.AwsPlacementGroupList{}
...
func (c *FakeAwsPlacementGroups) Create(awsPlacementGroup *v1alpha1.AwsPlacementGroup) (result *v1alpha1.AwsPlacementGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsplacementgroupsResource, c.ns, awsPlacementGroup), &v1alpha1.AwsPlacementGroup{})
...
func (c *FakeAwsPlacementGroups) Update(awsPlacementGroup *v1alpha1.AwsPlacementGroup) (result *v1alpha1.AwsPlacementGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsplacementgroupsResource, c.ns, awsPlacementGroup), &v1alpha1.AwsPlacementGroup{})
...
func (c *FakeAwsPlacementGroups) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsplacementgroupsResource, c.ns, name), &v1alpha1.AwsPlacementGroup{})
...
func (c *FakeAwsPlacementGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsPlacementGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsplacementgroupsResource, c.ns, name, data, subresources...), &v1alpha1.AwsPlacementGroup{})
