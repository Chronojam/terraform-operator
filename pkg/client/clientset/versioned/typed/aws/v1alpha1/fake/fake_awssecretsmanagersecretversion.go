...
var awssecretsmanagersecretversionsResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awssecretsmanagersecretversions"}

var awssecretsmanagersecretversionsKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsSecretsmanagerSecretVersion"}
...
func (c *FakeAwsSecretsmanagerSecretVersions) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsSecretsmanagerSecretVersion, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awssecretsmanagersecretversionsResource, c.ns, name), &v1alpha1.AwsSecretsmanagerSecretVersion{})
...
func (c *FakeAwsSecretsmanagerSecretVersions) List(opts v1.ListOptions) (result *v1alpha1.AwsSecretsmanagerSecretVersionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awssecretsmanagersecretversionsResource, awssecretsmanagersecretversionsKind, c.ns, opts), &v1alpha1.AwsSecretsmanagerSecretVersionList{})
	...
	list := &v1alpha1.AwsSecretsmanagerSecretVersionList{}
...
func (c *FakeAwsSecretsmanagerSecretVersions) Create(awsSecretsmanagerSecretVersion *v1alpha1.AwsSecretsmanagerSecretVersion) (result *v1alpha1.AwsSecretsmanagerSecretVersion, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awssecretsmanagersecretversionsResource, c.ns, awsSecretsmanagerSecretVersion), &v1alpha1.AwsSecretsmanagerSecretVersion{})
...
func (c *FakeAwsSecretsmanagerSecretVersions) Update(awsSecretsmanagerSecretVersion *v1alpha1.AwsSecretsmanagerSecretVersion) (result *v1alpha1.AwsSecretsmanagerSecretVersion, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awssecretsmanagersecretversionsResource, c.ns, awsSecretsmanagerSecretVersion), &v1alpha1.AwsSecretsmanagerSecretVersion{})
...
func (c *FakeAwsSecretsmanagerSecretVersions) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awssecretsmanagersecretversionsResource, c.ns, name), &v1alpha1.AwsSecretsmanagerSecretVersion{})
...
func (c *FakeAwsSecretsmanagerSecretVersions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsSecretsmanagerSecretVersion, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awssecretsmanagersecretversionsResource, c.ns, name, data, subresources...), &v1alpha1.AwsSecretsmanagerSecretVersion{})
