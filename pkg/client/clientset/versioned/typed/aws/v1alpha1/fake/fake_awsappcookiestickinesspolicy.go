...
func (c *FakeAwsAppCookieStickinessPolicies) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsAppCookieStickinessPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsappcookiestickinesspoliciesResource, c.ns, name), &v1alpha1.AwsAppCookieStickinessPolicy{})
...
func (c *FakeAwsAppCookieStickinessPolicies) List(opts v1.ListOptions) (result *v1alpha1.AwsAppCookieStickinessPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsappcookiestickinesspoliciesResource, awsappcookiestickinesspoliciesKind, c.ns, opts), &v1alpha1.AwsAppCookieStickinessPolicyList{})
	...
	list := &v1alpha1.AwsAppCookieStickinessPolicyList{}
...
func (c *FakeAwsAppCookieStickinessPolicies) Create(awsAppCookieStickinessPolicy *v1alpha1.AwsAppCookieStickinessPolicy) (result *v1alpha1.AwsAppCookieStickinessPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsappcookiestickinesspoliciesResource, c.ns, awsAppCookieStickinessPolicy), &v1alpha1.AwsAppCookieStickinessPolicy{})
...
func (c *FakeAwsAppCookieStickinessPolicies) Update(awsAppCookieStickinessPolicy *v1alpha1.AwsAppCookieStickinessPolicy) (result *v1alpha1.AwsAppCookieStickinessPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsappcookiestickinesspoliciesResource, c.ns, awsAppCookieStickinessPolicy), &v1alpha1.AwsAppCookieStickinessPolicy{})
...
func (c *FakeAwsAppCookieStickinessPolicies) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsappcookiestickinesspoliciesResource, c.ns, name), &v1alpha1.AwsAppCookieStickinessPolicy{})
...
func (c *FakeAwsAppCookieStickinessPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsAppCookieStickinessPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsappcookiestickinesspoliciesResource, c.ns, name, data, subresources...), &v1alpha1.AwsAppCookieStickinessPolicy{})
