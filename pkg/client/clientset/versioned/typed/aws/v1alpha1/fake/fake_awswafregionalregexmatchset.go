...
var awswafregionalregexmatchsetsResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awswafregionalregexmatchsets"}

var awswafregionalregexmatchsetsKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsWafregionalRegexMatchSet"}
...
func (c *FakeAwsWafregionalRegexMatchSets) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsWafregionalRegexMatchSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awswafregionalregexmatchsetsResource, c.ns, name), &v1alpha1.AwsWafregionalRegexMatchSet{})
...
func (c *FakeAwsWafregionalRegexMatchSets) List(opts v1.ListOptions) (result *v1alpha1.AwsWafregionalRegexMatchSetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awswafregionalregexmatchsetsResource, awswafregionalregexmatchsetsKind, c.ns, opts), &v1alpha1.AwsWafregionalRegexMatchSetList{})
	...
	list := &v1alpha1.AwsWafregionalRegexMatchSetList{}
...
func (c *FakeAwsWafregionalRegexMatchSets) Create(awsWafregionalRegexMatchSet *v1alpha1.AwsWafregionalRegexMatchSet) (result *v1alpha1.AwsWafregionalRegexMatchSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awswafregionalregexmatchsetsResource, c.ns, awsWafregionalRegexMatchSet), &v1alpha1.AwsWafregionalRegexMatchSet{})
...
func (c *FakeAwsWafregionalRegexMatchSets) Update(awsWafregionalRegexMatchSet *v1alpha1.AwsWafregionalRegexMatchSet) (result *v1alpha1.AwsWafregionalRegexMatchSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awswafregionalregexmatchsetsResource, c.ns, awsWafregionalRegexMatchSet), &v1alpha1.AwsWafregionalRegexMatchSet{})
...
func (c *FakeAwsWafregionalRegexMatchSets) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awswafregionalregexmatchsetsResource, c.ns, name), &v1alpha1.AwsWafregionalRegexMatchSet{})
...
func (c *FakeAwsWafregionalRegexMatchSets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsWafregionalRegexMatchSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awswafregionalregexmatchsetsResource, c.ns, name, data, subresources...), &v1alpha1.AwsWafregionalRegexMatchSet{})
