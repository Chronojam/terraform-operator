...
func (c *FakeAwsEcrRepositories) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsEcrRepository, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsecrrepositoriesResource, c.ns, name), &v1alpha1.AwsEcrRepository{})
...
func (c *FakeAwsEcrRepositories) List(opts v1.ListOptions) (result *v1alpha1.AwsEcrRepositoryList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsecrrepositoriesResource, awsecrrepositoriesKind, c.ns, opts), &v1alpha1.AwsEcrRepositoryList{})
	...
	list := &v1alpha1.AwsEcrRepositoryList{}
...
func (c *FakeAwsEcrRepositories) Create(awsEcrRepository *v1alpha1.AwsEcrRepository) (result *v1alpha1.AwsEcrRepository, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsecrrepositoriesResource, c.ns, awsEcrRepository), &v1alpha1.AwsEcrRepository{})
...
func (c *FakeAwsEcrRepositories) Update(awsEcrRepository *v1alpha1.AwsEcrRepository) (result *v1alpha1.AwsEcrRepository, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsecrrepositoriesResource, c.ns, awsEcrRepository), &v1alpha1.AwsEcrRepository{})
...
func (c *FakeAwsEcrRepositories) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsecrrepositoriesResource, c.ns, name), &v1alpha1.AwsEcrRepository{})
...
func (c *FakeAwsEcrRepositories) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsEcrRepository, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsecrrepositoriesResource, c.ns, name, data, subresources...), &v1alpha1.AwsEcrRepository{})
