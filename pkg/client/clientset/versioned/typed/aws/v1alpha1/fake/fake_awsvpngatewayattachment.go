...
func (c *FakeAwsVpnGatewayAttachments) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsVpnGatewayAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsvpngatewayattachmentsResource, c.ns, name), &v1alpha1.AwsVpnGatewayAttachment{})
...
func (c *FakeAwsVpnGatewayAttachments) List(opts v1.ListOptions) (result *v1alpha1.AwsVpnGatewayAttachmentList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsvpngatewayattachmentsResource, awsvpngatewayattachmentsKind, c.ns, opts), &v1alpha1.AwsVpnGatewayAttachmentList{})
	...
	list := &v1alpha1.AwsVpnGatewayAttachmentList{}
...
func (c *FakeAwsVpnGatewayAttachments) Create(awsVpnGatewayAttachment *v1alpha1.AwsVpnGatewayAttachment) (result *v1alpha1.AwsVpnGatewayAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsvpngatewayattachmentsResource, c.ns, awsVpnGatewayAttachment), &v1alpha1.AwsVpnGatewayAttachment{})
...
func (c *FakeAwsVpnGatewayAttachments) Update(awsVpnGatewayAttachment *v1alpha1.AwsVpnGatewayAttachment) (result *v1alpha1.AwsVpnGatewayAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsvpngatewayattachmentsResource, c.ns, awsVpnGatewayAttachment), &v1alpha1.AwsVpnGatewayAttachment{})
...
func (c *FakeAwsVpnGatewayAttachments) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsvpngatewayattachmentsResource, c.ns, name), &v1alpha1.AwsVpnGatewayAttachment{})
...
func (c *FakeAwsVpnGatewayAttachments) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsVpnGatewayAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsvpngatewayattachmentsResource, c.ns, name, data, subresources...), &v1alpha1.AwsVpnGatewayAttachment{})
