...
func (c *FakeAwsRoute53QueryLogs) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsRoute53QueryLog, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsroute53querylogsResource, c.ns, name), &v1alpha1.AwsRoute53QueryLog{})
...
func (c *FakeAwsRoute53QueryLogs) List(opts v1.ListOptions) (result *v1alpha1.AwsRoute53QueryLogList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsroute53querylogsResource, awsroute53querylogsKind, c.ns, opts), &v1alpha1.AwsRoute53QueryLogList{})
	...
	list := &v1alpha1.AwsRoute53QueryLogList{}
...
func (c *FakeAwsRoute53QueryLogs) Create(awsRoute53QueryLog *v1alpha1.AwsRoute53QueryLog) (result *v1alpha1.AwsRoute53QueryLog, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsroute53querylogsResource, c.ns, awsRoute53QueryLog), &v1alpha1.AwsRoute53QueryLog{})
...
func (c *FakeAwsRoute53QueryLogs) Update(awsRoute53QueryLog *v1alpha1.AwsRoute53QueryLog) (result *v1alpha1.AwsRoute53QueryLog, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsroute53querylogsResource, c.ns, awsRoute53QueryLog), &v1alpha1.AwsRoute53QueryLog{})
...
func (c *FakeAwsRoute53QueryLogs) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsroute53querylogsResource, c.ns, name), &v1alpha1.AwsRoute53QueryLog{})
...
func (c *FakeAwsRoute53QueryLogs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsRoute53QueryLog, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsroute53querylogsResource, c.ns, name, data, subresources...), &v1alpha1.AwsRoute53QueryLog{})
