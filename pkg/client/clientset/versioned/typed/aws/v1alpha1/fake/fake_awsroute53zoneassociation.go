...
var awsroute53zoneassociationsResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awsroute53zoneassociations"}

var awsroute53zoneassociationsKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsRoute53ZoneAssociation"}
...
func (c *FakeAwsRoute53ZoneAssociations) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsRoute53ZoneAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsroute53zoneassociationsResource, c.ns, name), &v1alpha1.AwsRoute53ZoneAssociation{})
...
func (c *FakeAwsRoute53ZoneAssociations) List(opts v1.ListOptions) (result *v1alpha1.AwsRoute53ZoneAssociationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsroute53zoneassociationsResource, awsroute53zoneassociationsKind, c.ns, opts), &v1alpha1.AwsRoute53ZoneAssociationList{})
	...
	list := &v1alpha1.AwsRoute53ZoneAssociationList{}
...
func (c *FakeAwsRoute53ZoneAssociations) Create(awsRoute53ZoneAssociation *v1alpha1.AwsRoute53ZoneAssociation) (result *v1alpha1.AwsRoute53ZoneAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsroute53zoneassociationsResource, c.ns, awsRoute53ZoneAssociation), &v1alpha1.AwsRoute53ZoneAssociation{})
...
func (c *FakeAwsRoute53ZoneAssociations) Update(awsRoute53ZoneAssociation *v1alpha1.AwsRoute53ZoneAssociation) (result *v1alpha1.AwsRoute53ZoneAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsroute53zoneassociationsResource, c.ns, awsRoute53ZoneAssociation), &v1alpha1.AwsRoute53ZoneAssociation{})
...
func (c *FakeAwsRoute53ZoneAssociations) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsroute53zoneassociationsResource, c.ns, name), &v1alpha1.AwsRoute53ZoneAssociation{})
...
func (c *FakeAwsRoute53ZoneAssociations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsRoute53ZoneAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsroute53zoneassociationsResource, c.ns, name, data, subresources...), &v1alpha1.AwsRoute53ZoneAssociation{})
