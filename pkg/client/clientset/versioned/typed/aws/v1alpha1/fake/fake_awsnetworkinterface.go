...
func (c *FakeAwsNetworkInterfaces) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsNetworkInterface, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsnetworkinterfacesResource, c.ns, name), &v1alpha1.AwsNetworkInterface{})
...
func (c *FakeAwsNetworkInterfaces) List(opts v1.ListOptions) (result *v1alpha1.AwsNetworkInterfaceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsnetworkinterfacesResource, awsnetworkinterfacesKind, c.ns, opts), &v1alpha1.AwsNetworkInterfaceList{})
	...
	list := &v1alpha1.AwsNetworkInterfaceList{}
...
func (c *FakeAwsNetworkInterfaces) Create(awsNetworkInterface *v1alpha1.AwsNetworkInterface) (result *v1alpha1.AwsNetworkInterface, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsnetworkinterfacesResource, c.ns, awsNetworkInterface), &v1alpha1.AwsNetworkInterface{})
...
func (c *FakeAwsNetworkInterfaces) Update(awsNetworkInterface *v1alpha1.AwsNetworkInterface) (result *v1alpha1.AwsNetworkInterface, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsnetworkinterfacesResource, c.ns, awsNetworkInterface), &v1alpha1.AwsNetworkInterface{})
...
func (c *FakeAwsNetworkInterfaces) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsnetworkinterfacesResource, c.ns, name), &v1alpha1.AwsNetworkInterface{})
...
func (c *FakeAwsNetworkInterfaces) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsNetworkInterface, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsnetworkinterfacesResource, c.ns, name, data, subresources...), &v1alpha1.AwsNetworkInterface{})
