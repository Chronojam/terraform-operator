...
var awsappsyncgraphqlapisResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awsappsyncgraphqlapis"}

var awsappsyncgraphqlapisKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsAppsyncGraphqlApi"}
...
func (c *FakeAwsAppsyncGraphqlApis) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsAppsyncGraphqlApi, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsappsyncgraphqlapisResource, c.ns, name), &v1alpha1.AwsAppsyncGraphqlApi{})
...
func (c *FakeAwsAppsyncGraphqlApis) List(opts v1.ListOptions) (result *v1alpha1.AwsAppsyncGraphqlApiList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsappsyncgraphqlapisResource, awsappsyncgraphqlapisKind, c.ns, opts), &v1alpha1.AwsAppsyncGraphqlApiList{})
	...
	list := &v1alpha1.AwsAppsyncGraphqlApiList{}
...
func (c *FakeAwsAppsyncGraphqlApis) Create(awsAppsyncGraphqlApi *v1alpha1.AwsAppsyncGraphqlApi) (result *v1alpha1.AwsAppsyncGraphqlApi, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsappsyncgraphqlapisResource, c.ns, awsAppsyncGraphqlApi), &v1alpha1.AwsAppsyncGraphqlApi{})
...
func (c *FakeAwsAppsyncGraphqlApis) Update(awsAppsyncGraphqlApi *v1alpha1.AwsAppsyncGraphqlApi) (result *v1alpha1.AwsAppsyncGraphqlApi, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsappsyncgraphqlapisResource, c.ns, awsAppsyncGraphqlApi), &v1alpha1.AwsAppsyncGraphqlApi{})
...
func (c *FakeAwsAppsyncGraphqlApis) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsappsyncgraphqlapisResource, c.ns, name), &v1alpha1.AwsAppsyncGraphqlApi{})
...
func (c *FakeAwsAppsyncGraphqlApis) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsAppsyncGraphqlApi, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsappsyncgraphqlapisResource, c.ns, name, data, subresources...), &v1alpha1.AwsAppsyncGraphqlApi{})
