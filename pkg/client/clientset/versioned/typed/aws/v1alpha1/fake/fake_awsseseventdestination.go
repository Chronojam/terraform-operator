...
var awsseseventdestinationsResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awsseseventdestinations"}

var awsseseventdestinationsKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsSesEventDestination"}
...
func (c *FakeAwsSesEventDestinations) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsSesEventDestination, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsseseventdestinationsResource, c.ns, name), &v1alpha1.AwsSesEventDestination{})
...
func (c *FakeAwsSesEventDestinations) List(opts v1.ListOptions) (result *v1alpha1.AwsSesEventDestinationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsseseventdestinationsResource, awsseseventdestinationsKind, c.ns, opts), &v1alpha1.AwsSesEventDestinationList{})
	...
	list := &v1alpha1.AwsSesEventDestinationList{}
...
func (c *FakeAwsSesEventDestinations) Create(awsSesEventDestination *v1alpha1.AwsSesEventDestination) (result *v1alpha1.AwsSesEventDestination, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsseseventdestinationsResource, c.ns, awsSesEventDestination), &v1alpha1.AwsSesEventDestination{})
...
func (c *FakeAwsSesEventDestinations) Update(awsSesEventDestination *v1alpha1.AwsSesEventDestination) (result *v1alpha1.AwsSesEventDestination, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsseseventdestinationsResource, c.ns, awsSesEventDestination), &v1alpha1.AwsSesEventDestination{})
...
func (c *FakeAwsSesEventDestinations) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsseseventdestinationsResource, c.ns, name), &v1alpha1.AwsSesEventDestination{})
...
func (c *FakeAwsSesEventDestinations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsSesEventDestination, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsseseventdestinationsResource, c.ns, name, data, subresources...), &v1alpha1.AwsSesEventDestination{})
