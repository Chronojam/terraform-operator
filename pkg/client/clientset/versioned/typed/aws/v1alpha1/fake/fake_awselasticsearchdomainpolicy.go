...
var awselasticsearchdomainpoliciesResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awselasticsearchdomainpolicies"}

var awselasticsearchdomainpoliciesKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsElasticsearchDomainPolicy"}
...
func (c *FakeAwsElasticsearchDomainPolicies) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsElasticsearchDomainPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awselasticsearchdomainpoliciesResource, c.ns, name), &v1alpha1.AwsElasticsearchDomainPolicy{})
...
func (c *FakeAwsElasticsearchDomainPolicies) List(opts v1.ListOptions) (result *v1alpha1.AwsElasticsearchDomainPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awselasticsearchdomainpoliciesResource, awselasticsearchdomainpoliciesKind, c.ns, opts), &v1alpha1.AwsElasticsearchDomainPolicyList{})
	...
	list := &v1alpha1.AwsElasticsearchDomainPolicyList{}
...
func (c *FakeAwsElasticsearchDomainPolicies) Create(awsElasticsearchDomainPolicy *v1alpha1.AwsElasticsearchDomainPolicy) (result *v1alpha1.AwsElasticsearchDomainPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awselasticsearchdomainpoliciesResource, c.ns, awsElasticsearchDomainPolicy), &v1alpha1.AwsElasticsearchDomainPolicy{})
...
func (c *FakeAwsElasticsearchDomainPolicies) Update(awsElasticsearchDomainPolicy *v1alpha1.AwsElasticsearchDomainPolicy) (result *v1alpha1.AwsElasticsearchDomainPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awselasticsearchdomainpoliciesResource, c.ns, awsElasticsearchDomainPolicy), &v1alpha1.AwsElasticsearchDomainPolicy{})
...
func (c *FakeAwsElasticsearchDomainPolicies) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awselasticsearchdomainpoliciesResource, c.ns, name), &v1alpha1.AwsElasticsearchDomainPolicy{})
...
func (c *FakeAwsElasticsearchDomainPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsElasticsearchDomainPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awselasticsearchdomainpoliciesResource, c.ns, name, data, subresources...), &v1alpha1.AwsElasticsearchDomainPolicy{})
