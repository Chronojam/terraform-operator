...
var awswafregexmatchsetsResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awswafregexmatchsets"}

var awswafregexmatchsetsKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsWafRegexMatchSet"}
...
func (c *FakeAwsWafRegexMatchSets) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsWafRegexMatchSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awswafregexmatchsetsResource, c.ns, name), &v1alpha1.AwsWafRegexMatchSet{})
...
func (c *FakeAwsWafRegexMatchSets) List(opts v1.ListOptions) (result *v1alpha1.AwsWafRegexMatchSetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awswafregexmatchsetsResource, awswafregexmatchsetsKind, c.ns, opts), &v1alpha1.AwsWafRegexMatchSetList{})
	...
	list := &v1alpha1.AwsWafRegexMatchSetList{}
...
func (c *FakeAwsWafRegexMatchSets) Create(awsWafRegexMatchSet *v1alpha1.AwsWafRegexMatchSet) (result *v1alpha1.AwsWafRegexMatchSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awswafregexmatchsetsResource, c.ns, awsWafRegexMatchSet), &v1alpha1.AwsWafRegexMatchSet{})
...
func (c *FakeAwsWafRegexMatchSets) Update(awsWafRegexMatchSet *v1alpha1.AwsWafRegexMatchSet) (result *v1alpha1.AwsWafRegexMatchSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awswafregexmatchsetsResource, c.ns, awsWafRegexMatchSet), &v1alpha1.AwsWafRegexMatchSet{})
...
func (c *FakeAwsWafRegexMatchSets) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awswafregexmatchsetsResource, c.ns, name), &v1alpha1.AwsWafRegexMatchSet{})
...
func (c *FakeAwsWafRegexMatchSets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsWafRegexMatchSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awswafregexmatchsetsResource, c.ns, name, data, subresources...), &v1alpha1.AwsWafRegexMatchSet{})
