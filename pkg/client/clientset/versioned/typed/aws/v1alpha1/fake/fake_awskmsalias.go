...
func (c *FakeAwsKmsAliases) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsKmsAlias, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awskmsaliasesResource, c.ns, name), &v1alpha1.AwsKmsAlias{})
...
func (c *FakeAwsKmsAliases) List(opts v1.ListOptions) (result *v1alpha1.AwsKmsAliasList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awskmsaliasesResource, awskmsaliasesKind, c.ns, opts), &v1alpha1.AwsKmsAliasList{})
...
func (c *FakeAwsKmsAliases) Create(awsKmsAlias *v1alpha1.AwsKmsAlias) (result *v1alpha1.AwsKmsAlias, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awskmsaliasesResource, c.ns, awsKmsAlias), &v1alpha1.AwsKmsAlias{})
...
func (c *FakeAwsKmsAliases) Update(awsKmsAlias *v1alpha1.AwsKmsAlias) (result *v1alpha1.AwsKmsAlias, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awskmsaliasesResource, c.ns, awsKmsAlias), &v1alpha1.AwsKmsAlias{})
...
func (c *FakeAwsKmsAliases) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awskmsaliasesResource, c.ns, name), &v1alpha1.AwsKmsAlias{})
...
func (c *FakeAwsKmsAliases) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsKmsAlias, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awskmsaliasesResource, c.ns, name, data, subresources...), &v1alpha1.AwsKmsAlias{})
