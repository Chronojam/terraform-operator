...
var awsiamgrouppolicyattachmentsResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awsiamgrouppolicyattachments"}

var awsiamgrouppolicyattachmentsKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsIamGroupPolicyAttachment"}
...
func (c *FakeAwsIamGroupPolicyAttachments) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsIamGroupPolicyAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsiamgrouppolicyattachmentsResource, c.ns, name), &v1alpha1.AwsIamGroupPolicyAttachment{})
...
func (c *FakeAwsIamGroupPolicyAttachments) List(opts v1.ListOptions) (result *v1alpha1.AwsIamGroupPolicyAttachmentList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsiamgrouppolicyattachmentsResource, awsiamgrouppolicyattachmentsKind, c.ns, opts), &v1alpha1.AwsIamGroupPolicyAttachmentList{})
	...
	list := &v1alpha1.AwsIamGroupPolicyAttachmentList{}
...
func (c *FakeAwsIamGroupPolicyAttachments) Create(awsIamGroupPolicyAttachment *v1alpha1.AwsIamGroupPolicyAttachment) (result *v1alpha1.AwsIamGroupPolicyAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsiamgrouppolicyattachmentsResource, c.ns, awsIamGroupPolicyAttachment), &v1alpha1.AwsIamGroupPolicyAttachment{})
...
func (c *FakeAwsIamGroupPolicyAttachments) Update(awsIamGroupPolicyAttachment *v1alpha1.AwsIamGroupPolicyAttachment) (result *v1alpha1.AwsIamGroupPolicyAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsiamgrouppolicyattachmentsResource, c.ns, awsIamGroupPolicyAttachment), &v1alpha1.AwsIamGroupPolicyAttachment{})
...
func (c *FakeAwsIamGroupPolicyAttachments) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsiamgrouppolicyattachmentsResource, c.ns, name), &v1alpha1.AwsIamGroupPolicyAttachment{})
...
func (c *FakeAwsIamGroupPolicyAttachments) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsIamGroupPolicyAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsiamgrouppolicyattachmentsResource, c.ns, name, data, subresources...), &v1alpha1.AwsIamGroupPolicyAttachment{})
