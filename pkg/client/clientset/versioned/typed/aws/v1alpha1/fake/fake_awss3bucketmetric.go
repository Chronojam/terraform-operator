...
func (c *FakeAwsS3BucketMetrics) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsS3BucketMetric, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awss3bucketmetricsResource, c.ns, name), &v1alpha1.AwsS3BucketMetric{})
...
func (c *FakeAwsS3BucketMetrics) List(opts v1.ListOptions) (result *v1alpha1.AwsS3BucketMetricList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awss3bucketmetricsResource, awss3bucketmetricsKind, c.ns, opts), &v1alpha1.AwsS3BucketMetricList{})
	...
	list := &v1alpha1.AwsS3BucketMetricList{}
...
func (c *FakeAwsS3BucketMetrics) Create(awsS3BucketMetric *v1alpha1.AwsS3BucketMetric) (result *v1alpha1.AwsS3BucketMetric, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awss3bucketmetricsResource, c.ns, awsS3BucketMetric), &v1alpha1.AwsS3BucketMetric{})
...
func (c *FakeAwsS3BucketMetrics) Update(awsS3BucketMetric *v1alpha1.AwsS3BucketMetric) (result *v1alpha1.AwsS3BucketMetric, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awss3bucketmetricsResource, c.ns, awsS3BucketMetric), &v1alpha1.AwsS3BucketMetric{})
...
func (c *FakeAwsS3BucketMetrics) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awss3bucketmetricsResource, c.ns, name), &v1alpha1.AwsS3BucketMetric{})
...
func (c *FakeAwsS3BucketMetrics) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsS3BucketMetric, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awss3bucketmetricsResource, c.ns, name, data, subresources...), &v1alpha1.AwsS3BucketMetric{})
