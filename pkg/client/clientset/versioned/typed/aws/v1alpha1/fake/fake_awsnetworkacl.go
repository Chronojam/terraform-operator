...
var awsnetworkaclsResource = schema.GroupVersionResource{Group: "aws", Version: "v1alpha1", Resource: "awsnetworkacls"}

var awsnetworkaclsKind = schema.GroupVersionKind{Group: "aws", Version: "v1alpha1", Kind: "AwsNetworkAcl"}
