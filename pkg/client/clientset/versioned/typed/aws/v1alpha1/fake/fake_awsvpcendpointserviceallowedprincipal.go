...
func (c *FakeAwsVpcEndpointServiceAllowedPrincipals) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsVpcEndpointServiceAllowedPrincipal, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsvpcendpointserviceallowedprincipalsResource, c.ns, name), &v1alpha1.AwsVpcEndpointServiceAllowedPrincipal{})
...
func (c *FakeAwsVpcEndpointServiceAllowedPrincipals) List(opts v1.ListOptions) (result *v1alpha1.AwsVpcEndpointServiceAllowedPrincipalList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsvpcendpointserviceallowedprincipalsResource, awsvpcendpointserviceallowedprincipalsKind, c.ns, opts), &v1alpha1.AwsVpcEndpointServiceAllowedPrincipalList{})
	...
	list := &v1alpha1.AwsVpcEndpointServiceAllowedPrincipalList{}
...
func (c *FakeAwsVpcEndpointServiceAllowedPrincipals) Create(awsVpcEndpointServiceAllowedPrincipal *v1alpha1.AwsVpcEndpointServiceAllowedPrincipal) (result *v1alpha1.AwsVpcEndpointServiceAllowedPrincipal, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsvpcendpointserviceallowedprincipalsResource, c.ns, awsVpcEndpointServiceAllowedPrincipal), &v1alpha1.AwsVpcEndpointServiceAllowedPrincipal{})
...
func (c *FakeAwsVpcEndpointServiceAllowedPrincipals) Update(awsVpcEndpointServiceAllowedPrincipal *v1alpha1.AwsVpcEndpointServiceAllowedPrincipal) (result *v1alpha1.AwsVpcEndpointServiceAllowedPrincipal, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsvpcendpointserviceallowedprincipalsResource, c.ns, awsVpcEndpointServiceAllowedPrincipal), &v1alpha1.AwsVpcEndpointServiceAllowedPrincipal{})
...
func (c *FakeAwsVpcEndpointServiceAllowedPrincipals) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsvpcendpointserviceallowedprincipalsResource, c.ns, name), &v1alpha1.AwsVpcEndpointServiceAllowedPrincipal{})
...
func (c *FakeAwsVpcEndpointServiceAllowedPrincipals) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsVpcEndpointServiceAllowedPrincipal, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsvpcendpointserviceallowedprincipalsResource, c.ns, name, data, subresources...), &v1alpha1.AwsVpcEndpointServiceAllowedPrincipal{})
