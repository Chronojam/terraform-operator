...
var awselastictranscoderpresetsResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awselastictranscoderpresets"}

var awselastictranscoderpresetsKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsElastictranscoderPreset"}
...
func (c *FakeAwsElastictranscoderPresets) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsElastictranscoderPreset, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awselastictranscoderpresetsResource, c.ns, name), &v1alpha1.AwsElastictranscoderPreset{})
...
func (c *FakeAwsElastictranscoderPresets) List(opts v1.ListOptions) (result *v1alpha1.AwsElastictranscoderPresetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awselastictranscoderpresetsResource, awselastictranscoderpresetsKind, c.ns, opts), &v1alpha1.AwsElastictranscoderPresetList{})
	...
	list := &v1alpha1.AwsElastictranscoderPresetList{}
...
func (c *FakeAwsElastictranscoderPresets) Create(awsElastictranscoderPreset *v1alpha1.AwsElastictranscoderPreset) (result *v1alpha1.AwsElastictranscoderPreset, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awselastictranscoderpresetsResource, c.ns, awsElastictranscoderPreset), &v1alpha1.AwsElastictranscoderPreset{})
...
func (c *FakeAwsElastictranscoderPresets) Update(awsElastictranscoderPreset *v1alpha1.AwsElastictranscoderPreset) (result *v1alpha1.AwsElastictranscoderPreset, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awselastictranscoderpresetsResource, c.ns, awsElastictranscoderPreset), &v1alpha1.AwsElastictranscoderPreset{})
...
func (c *FakeAwsElastictranscoderPresets) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awselastictranscoderpresetsResource, c.ns, name), &v1alpha1.AwsElastictranscoderPreset{})
...
func (c *FakeAwsElastictranscoderPresets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsElastictranscoderPreset, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awselastictranscoderpresetsResource, c.ns, name, data, subresources...), &v1alpha1.AwsElastictranscoderPreset{})
