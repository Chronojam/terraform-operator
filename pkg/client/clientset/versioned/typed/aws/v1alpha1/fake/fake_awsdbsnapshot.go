...
var awsdbsnapshotsResource = schema.GroupVersionResource{Group: "aws", Version: "v1alpha1", Resource: "awsdbsnapshots"}

var awsdbsnapshotsKind = schema.GroupVersionKind{Group: "aws", Version: "v1alpha1", Kind: "AwsDbSnapshot"}
