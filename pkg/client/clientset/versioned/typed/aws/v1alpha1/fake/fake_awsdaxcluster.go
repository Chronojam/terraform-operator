...
var awsdaxclustersResource = schema.GroupVersionResource{Group: "aws", Version: "v1alpha1", Resource: "awsdaxclusters"}

var awsdaxclustersKind = schema.GroupVersionKind{Group: "aws", Version: "v1alpha1", Kind: "AwsDaxCluster"}
