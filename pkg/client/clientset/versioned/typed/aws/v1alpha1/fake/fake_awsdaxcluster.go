...
var awsdaxclustersResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awsdaxclusters"}

var awsdaxclustersKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsDaxCluster"}
...
func (c *FakeAwsDaxClusters) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsDaxCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsdaxclustersResource, c.ns, name), &v1alpha1.AwsDaxCluster{})
...
func (c *FakeAwsDaxClusters) List(opts v1.ListOptions) (result *v1alpha1.AwsDaxClusterList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsdaxclustersResource, awsdaxclustersKind, c.ns, opts), &v1alpha1.AwsDaxClusterList{})
	...
	list := &v1alpha1.AwsDaxClusterList{}
...
func (c *FakeAwsDaxClusters) Create(awsDaxCluster *v1alpha1.AwsDaxCluster) (result *v1alpha1.AwsDaxCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsdaxclustersResource, c.ns, awsDaxCluster), &v1alpha1.AwsDaxCluster{})
...
func (c *FakeAwsDaxClusters) Update(awsDaxCluster *v1alpha1.AwsDaxCluster) (result *v1alpha1.AwsDaxCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsdaxclustersResource, c.ns, awsDaxCluster), &v1alpha1.AwsDaxCluster{})
...
func (c *FakeAwsDaxClusters) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsdaxclustersResource, c.ns, name), &v1alpha1.AwsDaxCluster{})
...
func (c *FakeAwsDaxClusters) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsDaxCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsdaxclustersResource, c.ns, name, data, subresources...), &v1alpha1.AwsDaxCluster{})
