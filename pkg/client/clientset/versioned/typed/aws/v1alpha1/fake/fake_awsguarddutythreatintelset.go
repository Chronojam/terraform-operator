...
func (c *FakeAwsGuarddutyThreatintelsets) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsGuarddutyThreatintelset, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awsguarddutythreatintelsetsResource, c.ns, name), &v1alpha1.AwsGuarddutyThreatintelset{})
...
func (c *FakeAwsGuarddutyThreatintelsets) List(opts v1.ListOptions) (result *v1alpha1.AwsGuarddutyThreatintelsetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awsguarddutythreatintelsetsResource, awsguarddutythreatintelsetsKind, c.ns, opts), &v1alpha1.AwsGuarddutyThreatintelsetList{})
	...
	list := &v1alpha1.AwsGuarddutyThreatintelsetList{}
...
func (c *FakeAwsGuarddutyThreatintelsets) Create(awsGuarddutyThreatintelset *v1alpha1.AwsGuarddutyThreatintelset) (result *v1alpha1.AwsGuarddutyThreatintelset, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awsguarddutythreatintelsetsResource, c.ns, awsGuarddutyThreatintelset), &v1alpha1.AwsGuarddutyThreatintelset{})
...
func (c *FakeAwsGuarddutyThreatintelsets) Update(awsGuarddutyThreatintelset *v1alpha1.AwsGuarddutyThreatintelset) (result *v1alpha1.AwsGuarddutyThreatintelset, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awsguarddutythreatintelsetsResource, c.ns, awsGuarddutyThreatintelset), &v1alpha1.AwsGuarddutyThreatintelset{})
...
func (c *FakeAwsGuarddutyThreatintelsets) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awsguarddutythreatintelsetsResource, c.ns, name), &v1alpha1.AwsGuarddutyThreatintelset{})
...
func (c *FakeAwsGuarddutyThreatintelsets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsGuarddutyThreatintelset, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awsguarddutythreatintelsetsResource, c.ns, name, data, subresources...), &v1alpha1.AwsGuarddutyThreatintelset{})
