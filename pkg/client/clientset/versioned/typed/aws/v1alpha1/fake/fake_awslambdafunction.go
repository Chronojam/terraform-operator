...
func (c *FakeAwsLambdaFunctions) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsLambdaFunction, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awslambdafunctionsResource, c.ns, name), &v1alpha1.AwsLambdaFunction{})
...
func (c *FakeAwsLambdaFunctions) List(opts v1.ListOptions) (result *v1alpha1.AwsLambdaFunctionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awslambdafunctionsResource, awslambdafunctionsKind, c.ns, opts), &v1alpha1.AwsLambdaFunctionList{})
	...
	list := &v1alpha1.AwsLambdaFunctionList{}
...
func (c *FakeAwsLambdaFunctions) Create(awsLambdaFunction *v1alpha1.AwsLambdaFunction) (result *v1alpha1.AwsLambdaFunction, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awslambdafunctionsResource, c.ns, awsLambdaFunction), &v1alpha1.AwsLambdaFunction{})
...
func (c *FakeAwsLambdaFunctions) Update(awsLambdaFunction *v1alpha1.AwsLambdaFunction) (result *v1alpha1.AwsLambdaFunction, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awslambdafunctionsResource, c.ns, awsLambdaFunction), &v1alpha1.AwsLambdaFunction{})
...
func (c *FakeAwsLambdaFunctions) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awslambdafunctionsResource, c.ns, name), &v1alpha1.AwsLambdaFunction{})
...
func (c *FakeAwsLambdaFunctions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsLambdaFunction, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awslambdafunctionsResource, c.ns, name, data, subresources...), &v1alpha1.AwsLambdaFunction{})
