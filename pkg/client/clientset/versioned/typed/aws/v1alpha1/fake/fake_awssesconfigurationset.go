...
var awssesconfigurationsetsResource = schema.GroupVersionResource{Group: "chronojam.co.uk", Version: "v1alpha1", Resource: "awssesconfigurationsets"}

var awssesconfigurationsetsKind = schema.GroupVersionKind{Group: "chronojam.co.uk", Version: "v1alpha1", Kind: "AwsSesConfigurationSet"}
...
func (c *FakeAwsSesConfigurationSets) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsSesConfigurationSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(awssesconfigurationsetsResource, c.ns, name), &v1alpha1.AwsSesConfigurationSet{})
...
func (c *FakeAwsSesConfigurationSets) List(opts v1.ListOptions) (result *v1alpha1.AwsSesConfigurationSetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(awssesconfigurationsetsResource, awssesconfigurationsetsKind, c.ns, opts), &v1alpha1.AwsSesConfigurationSetList{})
	...
	list := &v1alpha1.AwsSesConfigurationSetList{}
...
func (c *FakeAwsSesConfigurationSets) Create(awsSesConfigurationSet *v1alpha1.AwsSesConfigurationSet) (result *v1alpha1.AwsSesConfigurationSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(awssesconfigurationsetsResource, c.ns, awsSesConfigurationSet), &v1alpha1.AwsSesConfigurationSet{})
...
func (c *FakeAwsSesConfigurationSets) Update(awsSesConfigurationSet *v1alpha1.AwsSesConfigurationSet) (result *v1alpha1.AwsSesConfigurationSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(awssesconfigurationsetsResource, c.ns, awsSesConfigurationSet), &v1alpha1.AwsSesConfigurationSet{})
...
func (c *FakeAwsSesConfigurationSets) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(awssesconfigurationsetsResource, c.ns, name), &v1alpha1.AwsSesConfigurationSet{})
...
func (c *FakeAwsSesConfigurationSets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsSesConfigurationSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(awssesconfigurationsetsResource, c.ns, name, data, subresources...), &v1alpha1.AwsSesConfigurationSet{})
