	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ChronojamV1alpha1().AwsElasticsearchDomainPolicies(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ChronojamV1alpha1().AwsElasticsearchDomainPolicies(namespace).Watch(options)
			},
		},
		&aws_v1alpha1.AwsElasticsearchDomainPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *awsElasticsearchDomainPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aws_v1alpha1.AwsElasticsearchDomainPolicy{}, f.defaultInformer)
}
