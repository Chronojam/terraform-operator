	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ChronojamV1alpha1().AwsLaunchTemplates(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ChronojamV1alpha1().AwsLaunchTemplates(namespace).Watch(options)
			},
		},
		&aws_v1alpha1.AwsLaunchTemplate{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *awsLaunchTemplateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aws_v1alpha1.AwsLaunchTemplate{}, f.defaultInformer)
}
