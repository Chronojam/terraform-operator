	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ChronojamV1alpha1().AwsSqsQueuePolicies(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ChronojamV1alpha1().AwsSqsQueuePolicies(namespace).Watch(options)
			},
		},
		&aws_v1alpha1.AwsSqsQueuePolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *awsSqsQueuePolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aws_v1alpha1.AwsSqsQueuePolicy{}, f.defaultInformer)
}
