	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ChronojamV1alpha1().AwsIamRolePolicies(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ChronojamV1alpha1().AwsIamRolePolicies(namespace).Watch(options)
			},
		},
		&aws_v1alpha1.AwsIamRolePolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *awsIamRolePolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aws_v1alpha1.AwsIamRolePolicy{}, f.defaultInformer)
}
