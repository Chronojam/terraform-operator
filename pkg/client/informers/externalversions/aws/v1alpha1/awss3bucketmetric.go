	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ChronojamV1alpha1().AwsS3BucketMetrics(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ChronojamV1alpha1().AwsS3BucketMetrics(namespace).Watch(options)
			},
		},
		&aws_v1alpha1.AwsS3BucketMetric{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *awsS3BucketMetricInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aws_v1alpha1.AwsS3BucketMetric{}, f.defaultInformer)
}
