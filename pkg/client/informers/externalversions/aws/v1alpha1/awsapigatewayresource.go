	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ChronojamV1alpha1().AwsApiGatewayResources(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ChronojamV1alpha1().AwsApiGatewayResources(namespace).Watch(options)
			},
		},
		&aws_v1alpha1.AwsApiGatewayResource{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *awsApiGatewayResourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aws_v1alpha1.AwsApiGatewayResource{}, f.defaultInformer)
}
