	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ChronojamV1alpha1().AwsSsmResourceDataSyncs(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ChronojamV1alpha1().AwsSsmResourceDataSyncs(namespace).Watch(options)
			},
		},
		&aws_v1alpha1.AwsSsmResourceDataSync{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *awsSsmResourceDataSyncInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aws_v1alpha1.AwsSsmResourceDataSync{}, f.defaultInformer)
}
