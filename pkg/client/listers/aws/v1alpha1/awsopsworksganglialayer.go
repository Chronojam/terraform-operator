...
// List lists all AwsOpsworksGangliaLayers in the indexer for a given namespace.
func (s awsOpsworksGangliaLayerNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsOpsworksGangliaLayer, err error) {
...
// Get retrieves the AwsOpsworksGangliaLayer from the indexer for a given namespace and name.
func (s awsOpsworksGangliaLayerNamespaceLister) Get(name string) (*v1alpha1.AwsOpsworksGangliaLayer, error) {
