...
// List lists all AwsWafregionalWebAcls in the indexer for a given namespace.
func (s awsWafregionalWebAclNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsWafregionalWebAcl, err error) {
...
// Get retrieves the AwsWafregionalWebAcl from the indexer for a given namespace and name.
func (s awsWafregionalWebAclNamespaceLister) Get(name string) (*v1alpha1.AwsWafregionalWebAcl, error) {
