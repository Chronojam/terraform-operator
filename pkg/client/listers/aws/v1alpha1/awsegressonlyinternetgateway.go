...
// List lists all AwsEgressOnlyInternetGateways in the indexer for a given namespace.
func (s awsEgressOnlyInternetGatewayNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsEgressOnlyInternetGateway, err error) {
...
// Get retrieves the AwsEgressOnlyInternetGateway from the indexer for a given namespace and name.
func (s awsEgressOnlyInternetGatewayNamespaceLister) Get(name string) (*v1alpha1.AwsEgressOnlyInternetGateway, error) {
