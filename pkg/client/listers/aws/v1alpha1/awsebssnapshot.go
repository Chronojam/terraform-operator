...
// List lists all AwsEbsSnapshots in the indexer for a given namespace.
func (s awsEbsSnapshotNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsEbsSnapshot, err error) {
...
// Get retrieves the AwsEbsSnapshot from the indexer for a given namespace and name.
func (s awsEbsSnapshotNamespaceLister) Get(name string) (*v1alpha1.AwsEbsSnapshot, error) {
