...
// List lists all AwsSecretsmanagerSecretVersions in the indexer for a given namespace.
func (s awsSecretsmanagerSecretVersionNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsSecretsmanagerSecretVersion, err error) {
...
// Get retrieves the AwsSecretsmanagerSecretVersion from the indexer for a given namespace and name.
func (s awsSecretsmanagerSecretVersionNamespaceLister) Get(name string) (*v1alpha1.AwsSecretsmanagerSecretVersion, error) {
