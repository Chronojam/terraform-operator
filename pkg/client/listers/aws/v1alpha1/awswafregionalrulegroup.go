...
// List lists all AwsWafregionalRuleGroups in the indexer for a given namespace.
func (s awsWafregionalRuleGroupNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsWafregionalRuleGroup, err error) {
...
// Get retrieves the AwsWafregionalRuleGroup from the indexer for a given namespace and name.
func (s awsWafregionalRuleGroupNamespaceLister) Get(name string) (*v1alpha1.AwsWafregionalRuleGroup, error) {
