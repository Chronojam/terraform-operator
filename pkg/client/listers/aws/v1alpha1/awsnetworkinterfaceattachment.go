...
// List lists all AwsNetworkInterfaceAttachments in the indexer for a given namespace.
func (s awsNetworkInterfaceAttachmentNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsNetworkInterfaceAttachment, err error) {
...
// Get retrieves the AwsNetworkInterfaceAttachment from the indexer for a given namespace and name.
func (s awsNetworkInterfaceAttachmentNamespaceLister) Get(name string) (*v1alpha1.AwsNetworkInterfaceAttachment, error) {
