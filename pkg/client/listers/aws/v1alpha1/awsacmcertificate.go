...
// List lists all AwsAcmCertificates in the indexer for a given namespace.
func (s awsAcmCertificateNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsAcmCertificate, err error) {
...
// Get retrieves the AwsAcmCertificate from the indexer for a given namespace and name.
func (s awsAcmCertificateNamespaceLister) Get(name string) (*v1alpha1.AwsAcmCertificate, error) {
