...
// List lists all AwsDynamodbGlobalTables in the indexer for a given namespace.
func (s awsDynamodbGlobalTableNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsDynamodbGlobalTable, err error) {
...
// Get retrieves the AwsDynamodbGlobalTable from the indexer for a given namespace and name.
func (s awsDynamodbGlobalTableNamespaceLister) Get(name string) (*v1alpha1.AwsDynamodbGlobalTable, error) {
