...
// List lists all AwsElasticsearchDomains in the indexer for a given namespace.
func (s awsElasticsearchDomainNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsElasticsearchDomain, err error) {
...
// Get retrieves the AwsElasticsearchDomain from the indexer for a given namespace and name.
func (s awsElasticsearchDomainNamespaceLister) Get(name string) (*v1alpha1.AwsElasticsearchDomain, error) {
