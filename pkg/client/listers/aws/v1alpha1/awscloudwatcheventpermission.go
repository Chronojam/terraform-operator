...
// List lists all AwsCloudwatchEventPermissions in the indexer for a given namespace.
func (s awsCloudwatchEventPermissionNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsCloudwatchEventPermission, err error) {
...
// Get retrieves the AwsCloudwatchEventPermission from the indexer for a given namespace and name.
func (s awsCloudwatchEventPermissionNamespaceLister) Get(name string) (*v1alpha1.AwsCloudwatchEventPermission, error) {
