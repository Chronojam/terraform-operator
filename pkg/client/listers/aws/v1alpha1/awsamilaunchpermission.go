...
// List lists all AwsAmiLaunchPermissions in the indexer for a given namespace.
func (s awsAmiLaunchPermissionNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsAmiLaunchPermission, err error) {
...
// Get retrieves the AwsAmiLaunchPermission from the indexer for a given namespace and name.
func (s awsAmiLaunchPermissionNamespaceLister) Get(name string) (*v1alpha1.AwsAmiLaunchPermission, error) {
