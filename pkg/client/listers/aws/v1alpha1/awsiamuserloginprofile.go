...
// List lists all AwsIamUserLoginProfiles in the indexer for a given namespace.
func (s awsIamUserLoginProfileNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsIamUserLoginProfile, err error) {
...
// Get retrieves the AwsIamUserLoginProfile from the indexer for a given namespace and name.
func (s awsIamUserLoginProfileNamespaceLister) Get(name string) (*v1alpha1.AwsIamUserLoginProfile, error) {
