...
// List lists all AwsIamGroupPolicies in the indexer for a given namespace.
func (s awsIamGroupPolicyNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsIamGroupPolicy, err error) {
...
// Get retrieves the AwsIamGroupPolicy from the indexer for a given namespace and name.
func (s awsIamGroupPolicyNamespaceLister) Get(name string) (*v1alpha1.AwsIamGroupPolicy, error) {
