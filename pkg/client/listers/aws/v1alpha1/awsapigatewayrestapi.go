...
// List lists all AwsApiGatewayRestApis in the indexer for a given namespace.
func (s awsApiGatewayRestApiNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsApiGatewayRestApi, err error) {
...
// Get retrieves the AwsApiGatewayRestApi from the indexer for a given namespace and name.
func (s awsApiGatewayRestApiNamespaceLister) Get(name string) (*v1alpha1.AwsApiGatewayRestApi, error) {
