...
// List lists all AwsGlacierVaults in the indexer for a given namespace.
func (s awsGlacierVaultNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsGlacierVault, err error) {
...
// Get retrieves the AwsGlacierVault from the indexer for a given namespace and name.
func (s awsGlacierVaultNamespaceLister) Get(name string) (*v1alpha1.AwsGlacierVault, error) {
