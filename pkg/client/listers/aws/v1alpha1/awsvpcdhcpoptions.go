...
// List lists all AwsVpcDhcpOptionses in the indexer for a given namespace.
func (s awsVpcDhcpOptionsNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsVpcDhcpOptions, err error) {
...
// Get retrieves the AwsVpcDhcpOptions from the indexer for a given namespace and name.
func (s awsVpcDhcpOptionsNamespaceLister) Get(name string) (*v1alpha1.AwsVpcDhcpOptions, error) {
