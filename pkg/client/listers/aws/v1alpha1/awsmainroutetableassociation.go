...
// List lists all AwsMainRouteTableAssociations in the indexer for a given namespace.
func (s awsMainRouteTableAssociationNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsMainRouteTableAssociation, err error) {
...
// Get retrieves the AwsMainRouteTableAssociation from the indexer for a given namespace and name.
func (s awsMainRouteTableAssociationNamespaceLister) Get(name string) (*v1alpha1.AwsMainRouteTableAssociation, error) {
