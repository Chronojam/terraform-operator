...
// List lists all AwsBatchComputeEnvironments in the indexer for a given namespace.
func (s awsBatchComputeEnvironmentNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsBatchComputeEnvironment, err error) {
...
// Get retrieves the AwsBatchComputeEnvironment from the indexer for a given namespace and name.
func (s awsBatchComputeEnvironmentNamespaceLister) Get(name string) (*v1alpha1.AwsBatchComputeEnvironment, error) {
