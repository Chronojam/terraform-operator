...
// List lists all AwsMqConfigurations in the indexer for a given namespace.
func (s awsMqConfigurationNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsMqConfiguration, err error) {
...
// Get retrieves the AwsMqConfiguration from the indexer for a given namespace and name.
func (s awsMqConfigurationNamespaceLister) Get(name string) (*v1alpha1.AwsMqConfiguration, error) {
