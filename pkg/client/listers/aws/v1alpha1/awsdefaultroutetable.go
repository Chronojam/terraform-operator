...
// List lists all AwsDefaultRouteTables in the indexer for a given namespace.
func (s awsDefaultRouteTableNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsDefaultRouteTable, err error) {
...
// Get retrieves the AwsDefaultRouteTable from the indexer for a given namespace and name.
func (s awsDefaultRouteTableNamespaceLister) Get(name string) (*v1alpha1.AwsDefaultRouteTable, error) {
