...
// List lists all AwsIotCertificates in the indexer for a given namespace.
func (s awsIotCertificateNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsIotCertificate, err error) {
...
// Get retrieves the AwsIotCertificate from the indexer for a given namespace and name.
func (s awsIotCertificateNamespaceLister) Get(name string) (*v1alpha1.AwsIotCertificate, error) {
