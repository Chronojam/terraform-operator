...
// List lists all AwsSnsTopicPolicies in the indexer for a given namespace.
func (s awsSnsTopicPolicyNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsSnsTopicPolicy, err error) {
...
// Get retrieves the AwsSnsTopicPolicy from the indexer for a given namespace and name.
func (s awsSnsTopicPolicyNamespaceLister) Get(name string) (*v1alpha1.AwsSnsTopicPolicy, error) {
