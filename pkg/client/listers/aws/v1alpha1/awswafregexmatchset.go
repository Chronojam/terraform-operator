...
// List lists all AwsWafRegexMatchSets in the indexer for a given namespace.
func (s awsWafRegexMatchSetNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsWafRegexMatchSet, err error) {
...
// Get retrieves the AwsWafRegexMatchSet from the indexer for a given namespace and name.
func (s awsWafRegexMatchSetNamespaceLister) Get(name string) (*v1alpha1.AwsWafRegexMatchSet, error) {
