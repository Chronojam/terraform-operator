...
// List lists all AwsAthenaNamedQueries in the indexer for a given namespace.
func (s awsAthenaNamedQueryNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsAthenaNamedQuery, err error) {
...
// Get retrieves the AwsAthenaNamedQuery from the indexer for a given namespace and name.
func (s awsAthenaNamedQueryNamespaceLister) Get(name string) (*v1alpha1.AwsAthenaNamedQuery, error) {
