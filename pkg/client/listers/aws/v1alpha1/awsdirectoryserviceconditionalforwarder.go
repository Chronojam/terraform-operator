...
// List lists all AwsDirectoryServiceConditionalForwarders in the indexer for a given namespace.
func (s awsDirectoryServiceConditionalForwarderNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsDirectoryServiceConditionalForwarder, err error) {
...
// Get retrieves the AwsDirectoryServiceConditionalForwarder from the indexer for a given namespace and name.
func (s awsDirectoryServiceConditionalForwarderNamespaceLister) Get(name string) (*v1alpha1.AwsDirectoryServiceConditionalForwarder, error) {
