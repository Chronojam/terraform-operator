...
// List lists all AwsIotThings in the indexer for a given namespace.
func (s awsIotThingNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsIotThing, err error) {
...
// Get retrieves the AwsIotThing from the indexer for a given namespace and name.
func (s awsIotThingNamespaceLister) Get(name string) (*v1alpha1.AwsIotThing, error) {
