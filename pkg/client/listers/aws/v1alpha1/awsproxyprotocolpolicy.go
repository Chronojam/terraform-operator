...
// List lists all AwsProxyProtocolPolicies in the indexer for a given namespace.
func (s awsProxyProtocolPolicyNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsProxyProtocolPolicy, err error) {
...
// Get retrieves the AwsProxyProtocolPolicy from the indexer for a given namespace and name.
func (s awsProxyProtocolPolicyNamespaceLister) Get(name string) (*v1alpha1.AwsProxyProtocolPolicy, error) {
