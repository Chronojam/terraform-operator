...
// List lists all AwsLightsailInstances in the indexer for a given namespace.
func (s awsLightsailInstanceNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsLightsailInstance, err error) {
...
// Get retrieves the AwsLightsailInstance from the indexer for a given namespace and name.
func (s awsLightsailInstanceNamespaceLister) Get(name string) (*v1alpha1.AwsLightsailInstance, error) {
