...
// List lists all AwsConfigConfigurationRecorders in the indexer for a given namespace.
func (s awsConfigConfigurationRecorderNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsConfigConfigurationRecorder, err error) {
...
// Get retrieves the AwsConfigConfigurationRecorder from the indexer for a given namespace and name.
func (s awsConfigConfigurationRecorderNamespaceLister) Get(name string) (*v1alpha1.AwsConfigConfigurationRecorder, error) {
