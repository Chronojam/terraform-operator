...
// List lists all AwsApiGatewayVpcLinks in the indexer for a given namespace.
func (s awsApiGatewayVpcLinkNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsApiGatewayVpcLink, err error) {
...
// Get retrieves the AwsApiGatewayVpcLink from the indexer for a given namespace and name.
func (s awsApiGatewayVpcLinkNamespaceLister) Get(name string) (*v1alpha1.AwsApiGatewayVpcLink, error) {
