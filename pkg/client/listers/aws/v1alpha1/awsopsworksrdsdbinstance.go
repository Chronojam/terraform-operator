...
// List lists all AwsOpsworksRdsDbInstances in the indexer for a given namespace.
func (s awsOpsworksRdsDbInstanceNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsOpsworksRdsDbInstance, err error) {
...
// Get retrieves the AwsOpsworksRdsDbInstance from the indexer for a given namespace and name.
func (s awsOpsworksRdsDbInstanceNamespaceLister) Get(name string) (*v1alpha1.AwsOpsworksRdsDbInstance, error) {
