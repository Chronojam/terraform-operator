...
// List lists all AwsVpcPeeringConnectionAccepters in the indexer for a given namespace.
func (s awsVpcPeeringConnectionAccepterNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsVpcPeeringConnectionAccepter, err error) {
...
// Get retrieves the AwsVpcPeeringConnectionAccepter from the indexer for a given namespace and name.
func (s awsVpcPeeringConnectionAccepterNamespaceLister) Get(name string) (*v1alpha1.AwsVpcPeeringConnectionAccepter, error) {
