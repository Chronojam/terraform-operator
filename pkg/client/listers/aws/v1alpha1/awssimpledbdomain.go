...
// List lists all AwsSimpledbDomains in the indexer for a given namespace.
func (s awsSimpledbDomainNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsSimpledbDomain, err error) {
...
// Get retrieves the AwsSimpledbDomain from the indexer for a given namespace and name.
func (s awsSimpledbDomainNamespaceLister) Get(name string) (*v1alpha1.AwsSimpledbDomain, error) {
