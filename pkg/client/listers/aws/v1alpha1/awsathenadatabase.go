...
// List lists all AwsAthenaDatabases in the indexer for a given namespace.
func (s awsAthenaDatabaseNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsAthenaDatabase, err error) {
...
// Get retrieves the AwsAthenaDatabase from the indexer for a given namespace and name.
func (s awsAthenaDatabaseNamespaceLister) Get(name string) (*v1alpha1.AwsAthenaDatabase, error) {
