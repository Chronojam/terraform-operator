...
// List lists all AwsIamUserSshKeys in the indexer for a given namespace.
func (s awsIamUserSshKeyNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsIamUserSshKey, err error) {
...
// Get retrieves the AwsIamUserSshKey from the indexer for a given namespace and name.
func (s awsIamUserSshKeyNamespaceLister) Get(name string) (*v1alpha1.AwsIamUserSshKey, error) {
