...
// List lists all AwsCloudwatchEventRules in the indexer for a given namespace.
func (s awsCloudwatchEventRuleNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsCloudwatchEventRule, err error) {
...
// Get retrieves the AwsCloudwatchEventRule from the indexer for a given namespace and name.
func (s awsCloudwatchEventRuleNamespaceLister) Get(name string) (*v1alpha1.AwsCloudwatchEventRule, error) {
