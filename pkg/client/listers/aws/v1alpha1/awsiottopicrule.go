...
// List lists all AwsIotTopicRules in the indexer for a given namespace.
func (s awsIotTopicRuleNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsIotTopicRule, err error) {
...
// Get retrieves the AwsIotTopicRule from the indexer for a given namespace and name.
func (s awsIotTopicRuleNamespaceLister) Get(name string) (*v1alpha1.AwsIotTopicRule, error) {
