...
// List lists all AwsDxLags in the indexer for a given namespace.
func (s awsDxLagNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsDxLag, err error) {
...
// Get retrieves the AwsDxLag from the indexer for a given namespace and name.
func (s awsDxLagNamespaceLister) Get(name string) (*v1alpha1.AwsDxLag, error) {
