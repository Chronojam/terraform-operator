...
// List lists all AwsDefaultSubnets in the indexer for a given namespace.
func (s awsDefaultSubnetNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsDefaultSubnet, err error) {
...
// Get retrieves the AwsDefaultSubnet from the indexer for a given namespace and name.
func (s awsDefaultSubnetNamespaceLister) Get(name string) (*v1alpha1.AwsDefaultSubnet, error) {
