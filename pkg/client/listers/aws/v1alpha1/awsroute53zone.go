...
// List lists all AwsRoute53Zones in the indexer for a given namespace.
func (s awsRoute53ZoneNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsRoute53Zone, err error) {
...
// Get retrieves the AwsRoute53Zone from the indexer for a given namespace and name.
func (s awsRoute53ZoneNamespaceLister) Get(name string) (*v1alpha1.AwsRoute53Zone, error) {
