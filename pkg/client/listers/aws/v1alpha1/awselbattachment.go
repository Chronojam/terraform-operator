...
// List lists all AwsElbAttachments in the indexer for a given namespace.
func (s awsElbAttachmentNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsElbAttachment, err error) {
...
// Get retrieves the AwsElbAttachment from the indexer for a given namespace and name.
func (s awsElbAttachmentNamespaceLister) Get(name string) (*v1alpha1.AwsElbAttachment, error) {
