...
// List lists all AwsCloudwatchLogMetricFilters in the indexer for a given namespace.
func (s awsCloudwatchLogMetricFilterNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsCloudwatchLogMetricFilter, err error) {
...
// Get retrieves the AwsCloudwatchLogMetricFilter from the indexer for a given namespace and name.
func (s awsCloudwatchLogMetricFilterNamespaceLister) Get(name string) (*v1alpha1.AwsCloudwatchLogMetricFilter, error) {
