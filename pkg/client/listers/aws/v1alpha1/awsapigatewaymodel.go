...
// List lists all AwsApiGatewayModels in the indexer for a given namespace.
func (s awsApiGatewayModelNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsApiGatewayModel, err error) {
...
// Get retrieves the AwsApiGatewayModel from the indexer for a given namespace and name.
func (s awsApiGatewayModelNamespaceLister) Get(name string) (*v1alpha1.AwsApiGatewayModel, error) {
