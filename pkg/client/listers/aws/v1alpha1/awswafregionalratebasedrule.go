...
// List lists all AwsWafregionalRateBasedRules in the indexer for a given namespace.
func (s awsWafregionalRateBasedRuleNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsWafregionalRateBasedRule, err error) {
...
// Get retrieves the AwsWafregionalRateBasedRule from the indexer for a given namespace and name.
func (s awsWafregionalRateBasedRuleNamespaceLister) Get(name string) (*v1alpha1.AwsWafregionalRateBasedRule, error) {
