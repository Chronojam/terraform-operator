...
// List lists all AwsDmsCertificates in the indexer for a given namespace.
func (s awsDmsCertificateNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsDmsCertificate, err error) {
...
// Get retrieves the AwsDmsCertificate from the indexer for a given namespace and name.
func (s awsDmsCertificateNamespaceLister) Get(name string) (*v1alpha1.AwsDmsCertificate, error) {
