...
// List lists all AwsLambdaEventSourceMappings in the indexer for a given namespace.
func (s awsLambdaEventSourceMappingNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsLambdaEventSourceMapping, err error) {
...
// Get retrieves the AwsLambdaEventSourceMapping from the indexer for a given namespace and name.
func (s awsLambdaEventSourceMappingNamespaceLister) Get(name string) (*v1alpha1.AwsLambdaEventSourceMapping, error) {
