...
// List lists all AwsGameliftBuilds in the indexer for a given namespace.
func (s awsGameliftBuildNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsGameliftBuild, err error) {
...
// Get retrieves the AwsGameliftBuild from the indexer for a given namespace and name.
func (s awsGameliftBuildNamespaceLister) Get(name string) (*v1alpha1.AwsGameliftBuild, error) {
