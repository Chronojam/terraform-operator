...
// List lists all AwsAppsyncDatasources in the indexer for a given namespace.
func (s awsAppsyncDatasourceNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsAppsyncDatasource, err error) {
...
// Get retrieves the AwsAppsyncDatasource from the indexer for a given namespace and name.
func (s awsAppsyncDatasourceNamespaceLister) Get(name string) (*v1alpha1.AwsAppsyncDatasource, error) {
