...
// List lists all AwsApiGatewayDocumentationVersions in the indexer for a given namespace.
func (s awsApiGatewayDocumentationVersionNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsApiGatewayDocumentationVersion, err error) {
...
// Get retrieves the AwsApiGatewayDocumentationVersion from the indexer for a given namespace and name.
func (s awsApiGatewayDocumentationVersionNamespaceLister) Get(name string) (*v1alpha1.AwsApiGatewayDocumentationVersion, error) {
