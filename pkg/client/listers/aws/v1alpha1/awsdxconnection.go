...
// List lists all AwsDxConnections in the indexer for a given namespace.
func (s awsDxConnectionNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsDxConnection, err error) {
...
// Get retrieves the AwsDxConnection from the indexer for a given namespace and name.
func (s awsDxConnectionNamespaceLister) Get(name string) (*v1alpha1.AwsDxConnection, error) {
