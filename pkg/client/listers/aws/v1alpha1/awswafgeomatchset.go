...
// List lists all AwsWafGeoMatchSets in the indexer for a given namespace.
func (s awsWafGeoMatchSetNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsWafGeoMatchSet, err error) {
...
// Get retrieves the AwsWafGeoMatchSet from the indexer for a given namespace and name.
func (s awsWafGeoMatchSetNamespaceLister) Get(name string) (*v1alpha1.AwsWafGeoMatchSet, error) {
