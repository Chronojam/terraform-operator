...
// List lists all AwsOpsworksRailsAppLayers in the indexer for a given namespace.
func (s awsOpsworksRailsAppLayerNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsOpsworksRailsAppLayer, err error) {
...
// Get retrieves the AwsOpsworksRailsAppLayer from the indexer for a given namespace and name.
func (s awsOpsworksRailsAppLayerNamespaceLister) Get(name string) (*v1alpha1.AwsOpsworksRailsAppLayer, error) {
