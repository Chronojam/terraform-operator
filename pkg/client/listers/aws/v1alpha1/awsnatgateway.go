...
// List lists all AwsNatGateways in the indexer for a given namespace.
func (s awsNatGatewayNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsNatGateway, err error) {
...
// Get retrieves the AwsNatGateway from the indexer for a given namespace and name.
func (s awsNatGatewayNamespaceLister) Get(name string) (*v1alpha1.AwsNatGateway, error) {
