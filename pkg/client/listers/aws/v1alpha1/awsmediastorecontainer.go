...
// List lists all AwsMediaStoreContainers in the indexer for a given namespace.
func (s awsMediaStoreContainerNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsMediaStoreContainer, err error) {
...
// Get retrieves the AwsMediaStoreContainer from the indexer for a given namespace and name.
func (s awsMediaStoreContainerNamespaceLister) Get(name string) (*v1alpha1.AwsMediaStoreContainer, error) {
