...
// List lists all AwsApiGatewayApiKeys in the indexer for a given namespace.
func (s awsApiGatewayApiKeyNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsApiGatewayApiKey, err error) {
...
// Get retrieves the AwsApiGatewayApiKey from the indexer for a given namespace and name.
func (s awsApiGatewayApiKeyNamespaceLister) Get(name string) (*v1alpha1.AwsApiGatewayApiKey, error) {
