...
// List lists all AwsSecurityGroups in the indexer for a given namespace.
func (s awsSecurityGroupNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsSecurityGroup, err error) {
...
// Get retrieves the AwsSecurityGroup from the indexer for a given namespace and name.
func (s awsSecurityGroupNamespaceLister) Get(name string) (*v1alpha1.AwsSecurityGroup, error) {
