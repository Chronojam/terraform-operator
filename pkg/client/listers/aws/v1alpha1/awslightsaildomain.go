...
// List lists all AwsLightsailDomains in the indexer for a given namespace.
func (s awsLightsailDomainNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsLightsailDomain, err error) {
...
// Get retrieves the AwsLightsailDomain from the indexer for a given namespace and name.
func (s awsLightsailDomainNamespaceLister) Get(name string) (*v1alpha1.AwsLightsailDomain, error) {
