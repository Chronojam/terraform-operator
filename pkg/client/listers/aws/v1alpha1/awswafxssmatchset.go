...
// List lists all AwsWafXssMatchSets in the indexer for a given namespace.
func (s awsWafXssMatchSetNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsWafXssMatchSet, err error) {
...
// Get retrieves the AwsWafXssMatchSet from the indexer for a given namespace and name.
func (s awsWafXssMatchSetNamespaceLister) Get(name string) (*v1alpha1.AwsWafXssMatchSet, error) {
