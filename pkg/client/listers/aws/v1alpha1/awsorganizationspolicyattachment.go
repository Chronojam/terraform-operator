...
// List lists all AwsOrganizationsPolicyAttachments in the indexer for a given namespace.
func (s awsOrganizationsPolicyAttachmentNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsOrganizationsPolicyAttachment, err error) {
...
// Get retrieves the AwsOrganizationsPolicyAttachment from the indexer for a given namespace and name.
func (s awsOrganizationsPolicyAttachmentNamespaceLister) Get(name string) (*v1alpha1.AwsOrganizationsPolicyAttachment, error) {
