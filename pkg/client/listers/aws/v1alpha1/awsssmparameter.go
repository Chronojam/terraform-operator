...
// List lists all AwsSsmParameters in the indexer for a given namespace.
func (s awsSsmParameterNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsSsmParameter, err error) {
...
// Get retrieves the AwsSsmParameter from the indexer for a given namespace and name.
func (s awsSsmParameterNamespaceLister) Get(name string) (*v1alpha1.AwsSsmParameter, error) {
