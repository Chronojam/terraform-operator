...
// List lists all AwsElasticBeanstalkConfigurationTemplates in the indexer for a given namespace.
func (s awsElasticBeanstalkConfigurationTemplateNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsElasticBeanstalkConfigurationTemplate, err error) {
...
// Get retrieves the AwsElasticBeanstalkConfigurationTemplate from the indexer for a given namespace and name.
func (s awsElasticBeanstalkConfigurationTemplateNamespaceLister) Get(name string) (*v1alpha1.AwsElasticBeanstalkConfigurationTemplate, error) {
