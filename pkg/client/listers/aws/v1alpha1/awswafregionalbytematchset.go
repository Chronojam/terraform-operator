...
// List lists all AwsWafregionalByteMatchSets in the indexer for a given namespace.
func (s awsWafregionalByteMatchSetNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsWafregionalByteMatchSet, err error) {
...
// Get retrieves the AwsWafregionalByteMatchSet from the indexer for a given namespace and name.
func (s awsWafregionalByteMatchSetNamespaceLister) Get(name string) (*v1alpha1.AwsWafregionalByteMatchSet, error) {
