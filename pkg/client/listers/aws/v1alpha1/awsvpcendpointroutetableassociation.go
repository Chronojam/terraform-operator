...
// List lists all AwsVpcEndpointRouteTableAssociations in the indexer for a given namespace.
func (s awsVpcEndpointRouteTableAssociationNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsVpcEndpointRouteTableAssociation, err error) {
...
// Get retrieves the AwsVpcEndpointRouteTableAssociation from the indexer for a given namespace and name.
func (s awsVpcEndpointRouteTableAssociationNamespaceLister) Get(name string) (*v1alpha1.AwsVpcEndpointRouteTableAssociation, error) {
