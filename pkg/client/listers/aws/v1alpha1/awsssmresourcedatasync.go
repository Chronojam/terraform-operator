...
// List lists all AwsSsmResourceDataSyncs in the indexer for a given namespace.
func (s awsSsmResourceDataSyncNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsSsmResourceDataSync, err error) {
...
// Get retrieves the AwsSsmResourceDataSync from the indexer for a given namespace and name.
func (s awsSsmResourceDataSyncNamespaceLister) Get(name string) (*v1alpha1.AwsSsmResourceDataSync, error) {
