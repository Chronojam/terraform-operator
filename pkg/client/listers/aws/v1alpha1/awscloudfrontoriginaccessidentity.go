...
// List lists all AwsCloudfrontOriginAccessIdentities in the indexer for a given namespace.
func (s awsCloudfrontOriginAccessIdentityNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsCloudfrontOriginAccessIdentity, err error) {
...
// Get retrieves the AwsCloudfrontOriginAccessIdentity from the indexer for a given namespace and name.
func (s awsCloudfrontOriginAccessIdentityNamespaceLister) Get(name string) (*v1alpha1.AwsCloudfrontOriginAccessIdentity, error) {
