...
// List lists all AwsKeyPairs in the indexer for a given namespace.
func (s awsKeyPairNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsKeyPair, err error) {
...
// Get retrieves the AwsKeyPair from the indexer for a given namespace and name.
func (s awsKeyPairNamespaceLister) Get(name string) (*v1alpha1.AwsKeyPair, error) {
