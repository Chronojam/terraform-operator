...
// List lists all AwsCognitoUserGroups in the indexer for a given namespace.
func (s awsCognitoUserGroupNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsCognitoUserGroup, err error) {
...
// Get retrieves the AwsCognitoUserGroup from the indexer for a given namespace and name.
func (s awsCognitoUserGroupNamespaceLister) Get(name string) (*v1alpha1.AwsCognitoUserGroup, error) {
