...
// List lists all AwsLbListenerRules in the indexer for a given namespace.
func (s awsLbListenerRuleNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsLbListenerRule, err error) {
...
// Get retrieves the AwsLbListenerRule from the indexer for a given namespace and name.
func (s awsLbListenerRuleNamespaceLister) Get(name string) (*v1alpha1.AwsLbListenerRule, error) {
