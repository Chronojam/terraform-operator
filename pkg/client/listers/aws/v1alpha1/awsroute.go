...
// List lists all AwsRoutes in the indexer for a given namespace.
func (s awsRouteNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsRoute, err error) {
...
// Get retrieves the AwsRoute from the indexer for a given namespace and name.
func (s awsRouteNamespaceLister) Get(name string) (*v1alpha1.AwsRoute, error) {
