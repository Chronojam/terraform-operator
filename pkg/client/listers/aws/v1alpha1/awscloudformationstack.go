...
// List lists all AwsCloudformationStacks in the indexer for a given namespace.
func (s awsCloudformationStackNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsCloudformationStack, err error) {
...
// Get retrieves the AwsCloudformationStack from the indexer for a given namespace and name.
func (s awsCloudformationStackNamespaceLister) Get(name string) (*v1alpha1.AwsCloudformationStack, error) {
