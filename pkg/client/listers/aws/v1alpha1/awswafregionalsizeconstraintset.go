...
// List lists all AwsWafregionalSizeConstraintSets in the indexer for a given namespace.
func (s awsWafregionalSizeConstraintSetNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsWafregionalSizeConstraintSet, err error) {
...
// Get retrieves the AwsWafregionalSizeConstraintSet from the indexer for a given namespace and name.
func (s awsWafregionalSizeConstraintSetNamespaceLister) Get(name string) (*v1alpha1.AwsWafregionalSizeConstraintSet, error) {
