...
// List lists all AwsSsmPatchGroups in the indexer for a given namespace.
func (s awsSsmPatchGroupNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsSsmPatchGroup, err error) {
...
// Get retrieves the AwsSsmPatchGroup from the indexer for a given namespace and name.
func (s awsSsmPatchGroupNamespaceLister) Get(name string) (*v1alpha1.AwsSsmPatchGroup, error) {
