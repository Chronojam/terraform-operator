...
// List lists all AwsEcsServices in the indexer for a given namespace.
func (s awsEcsServiceNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsEcsService, err error) {
...
// Get retrieves the AwsEcsService from the indexer for a given namespace and name.
func (s awsEcsServiceNamespaceLister) Get(name string) (*v1alpha1.AwsEcsService, error) {
