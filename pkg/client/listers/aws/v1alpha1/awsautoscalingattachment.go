...
// List lists all AwsAutoscalingAttachments in the indexer for a given namespace.
func (s awsAutoscalingAttachmentNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsAutoscalingAttachment, err error) {
...
// Get retrieves the AwsAutoscalingAttachment from the indexer for a given namespace and name.
func (s awsAutoscalingAttachmentNamespaceLister) Get(name string) (*v1alpha1.AwsAutoscalingAttachment, error) {
