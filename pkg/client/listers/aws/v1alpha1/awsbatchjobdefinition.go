...
// List lists all AwsBatchJobDefinitions in the indexer for a given namespace.
func (s awsBatchJobDefinitionNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsBatchJobDefinition, err error) {
...
// Get retrieves the AwsBatchJobDefinition from the indexer for a given namespace and name.
func (s awsBatchJobDefinitionNamespaceLister) Get(name string) (*v1alpha1.AwsBatchJobDefinition, error) {
