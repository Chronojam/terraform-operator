...
// List lists all AwsSpotDatafeedSubscriptions in the indexer for a given namespace.
func (s awsSpotDatafeedSubscriptionNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsSpotDatafeedSubscription, err error) {
...
// Get retrieves the AwsSpotDatafeedSubscription from the indexer for a given namespace and name.
func (s awsSpotDatafeedSubscriptionNamespaceLister) Get(name string) (*v1alpha1.AwsSpotDatafeedSubscription, error) {
