...
// List lists all AwsCodedeployDeploymentGroups in the indexer for a given namespace.
func (s awsCodedeployDeploymentGroupNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsCodedeployDeploymentGroup, err error) {
...
// Get retrieves the AwsCodedeployDeploymentGroup from the indexer for a given namespace and name.
func (s awsCodedeployDeploymentGroupNamespaceLister) Get(name string) (*v1alpha1.AwsCodedeployDeploymentGroup, error) {
