...
// List lists all AwsIamOpenidConnectProviders in the indexer for a given namespace.
func (s awsIamOpenidConnectProviderNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsIamOpenidConnectProvider, err error) {
...
// Get retrieves the AwsIamOpenidConnectProvider from the indexer for a given namespace and name.
func (s awsIamOpenidConnectProviderNamespaceLister) Get(name string) (*v1alpha1.AwsIamOpenidConnectProvider, error) {
