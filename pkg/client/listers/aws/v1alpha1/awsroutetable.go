...
// List lists all AwsRouteTables in the indexer for a given namespace.
func (s awsRouteTableNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsRouteTable, err error) {
...
// Get retrieves the AwsRouteTable from the indexer for a given namespace and name.
func (s awsRouteTableNamespaceLister) Get(name string) (*v1alpha1.AwsRouteTable, error) {
