...
// List lists all AwsVpcEndpointConnectionNotifications in the indexer for a given namespace.
func (s awsVpcEndpointConnectionNotificationNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsVpcEndpointConnectionNotification, err error) {
...
// Get retrieves the AwsVpcEndpointConnectionNotification from the indexer for a given namespace and name.
func (s awsVpcEndpointConnectionNotificationNamespaceLister) Get(name string) (*v1alpha1.AwsVpcEndpointConnectionNotification, error) {
