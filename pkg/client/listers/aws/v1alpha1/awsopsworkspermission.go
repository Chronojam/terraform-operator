...
// List lists all AwsOpsworksPermissions in the indexer for a given namespace.
func (s awsOpsworksPermissionNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsOpsworksPermission, err error) {
...
// Get retrieves the AwsOpsworksPermission from the indexer for a given namespace and name.
func (s awsOpsworksPermissionNamespaceLister) Get(name string) (*v1alpha1.AwsOpsworksPermission, error) {
