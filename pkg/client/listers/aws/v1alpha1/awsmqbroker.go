...
// List lists all AwsMqBrokers in the indexer for a given namespace.
func (s awsMqBrokerNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsMqBroker, err error) {
...
// Get retrieves the AwsMqBroker from the indexer for a given namespace and name.
func (s awsMqBrokerNamespaceLister) Get(name string) (*v1alpha1.AwsMqBroker, error) {
