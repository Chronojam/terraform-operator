...
// List lists all AwsAppautoscalingTargets in the indexer for a given namespace.
func (s awsAppautoscalingTargetNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsAppautoscalingTarget, err error) {
...
// Get retrieves the AwsAppautoscalingTarget from the indexer for a given namespace and name.
func (s awsAppautoscalingTargetNamespaceLister) Get(name string) (*v1alpha1.AwsAppautoscalingTarget, error) {
