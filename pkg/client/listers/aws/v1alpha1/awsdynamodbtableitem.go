...
// List lists all AwsDynamodbTableItems in the indexer for a given namespace.
func (s awsDynamodbTableItemNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsDynamodbTableItem, err error) {
...
// Get retrieves the AwsDynamodbTableItem from the indexer for a given namespace and name.
func (s awsDynamodbTableItemNamespaceLister) Get(name string) (*v1alpha1.AwsDynamodbTableItem, error) {
