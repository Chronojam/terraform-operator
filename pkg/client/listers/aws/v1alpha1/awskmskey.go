...
// List lists all AwsKmsKeys in the indexer for a given namespace.
func (s awsKmsKeyNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsKmsKey, err error) {
...
// Get retrieves the AwsKmsKey from the indexer for a given namespace and name.
func (s awsKmsKeyNamespaceLister) Get(name string) (*v1alpha1.AwsKmsKey, error) {
