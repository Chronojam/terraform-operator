...
// List lists all AwsSesEventDestinations in the indexer for a given namespace.
func (s awsSesEventDestinationNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsSesEventDestination, err error) {
...
// Get retrieves the AwsSesEventDestination from the indexer for a given namespace and name.
func (s awsSesEventDestinationNamespaceLister) Get(name string) (*v1alpha1.AwsSesEventDestination, error) {
