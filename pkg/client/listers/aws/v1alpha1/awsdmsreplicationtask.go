...
// List lists all AwsDmsReplicationTasks in the indexer for a given namespace.
func (s awsDmsReplicationTaskNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsDmsReplicationTask, err error) {
...
// Get retrieves the AwsDmsReplicationTask from the indexer for a given namespace and name.
func (s awsDmsReplicationTaskNamespaceLister) Get(name string) (*v1alpha1.AwsDmsReplicationTask, error) {
