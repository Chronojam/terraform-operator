...
// List lists all AwsOrganizationsPolicies in the indexer for a given namespace.
func (s awsOrganizationsPolicyNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsOrganizationsPolicy, err error) {
...
// Get retrieves the AwsOrganizationsPolicy from the indexer for a given namespace and name.
func (s awsOrganizationsPolicyNamespaceLister) Get(name string) (*v1alpha1.AwsOrganizationsPolicy, error) {
