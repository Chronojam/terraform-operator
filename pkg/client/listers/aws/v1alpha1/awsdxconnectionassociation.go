...
// List lists all AwsDxConnectionAssociations in the indexer for a given namespace.
func (s awsDxConnectionAssociationNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsDxConnectionAssociation, err error) {
...
// Get retrieves the AwsDxConnectionAssociation from the indexer for a given namespace and name.
func (s awsDxConnectionAssociationNamespaceLister) Get(name string) (*v1alpha1.AwsDxConnectionAssociation, error) {
