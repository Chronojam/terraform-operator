...
// List lists all AwsWafregionalRules in the indexer for a given namespace.
func (s awsWafregionalRuleNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsWafregionalRule, err error) {
...
// Get retrieves the AwsWafregionalRule from the indexer for a given namespace and name.
func (s awsWafregionalRuleNamespaceLister) Get(name string) (*v1alpha1.AwsWafregionalRule, error) {
