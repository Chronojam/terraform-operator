...
// List lists all AwsVpnConnections in the indexer for a given namespace.
func (s awsVpnConnectionNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsVpnConnection, err error) {
...
// Get retrieves the AwsVpnConnection from the indexer for a given namespace and name.
func (s awsVpnConnectionNamespaceLister) Get(name string) (*v1alpha1.AwsVpnConnection, error) {
