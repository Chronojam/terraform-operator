...
// List lists all AwsConfigConfigurationRecorderStatuses in the indexer for a given namespace.
func (s awsConfigConfigurationRecorderStatusNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsConfigConfigurationRecorderStatus, err error) {
...
// Get retrieves the AwsConfigConfigurationRecorderStatus from the indexer for a given namespace and name.
func (s awsConfigConfigurationRecorderStatusNamespaceLister) Get(name string) (*v1alpha1.AwsConfigConfigurationRecorderStatus, error) {
