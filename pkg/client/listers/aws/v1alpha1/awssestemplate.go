...
// List lists all AwsSesTemplates in the indexer for a given namespace.
func (s awsSesTemplateNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsSesTemplate, err error) {
...
// Get retrieves the AwsSesTemplate from the indexer for a given namespace and name.
func (s awsSesTemplateNamespaceLister) Get(name string) (*v1alpha1.AwsSesTemplate, error) {
