...
// List lists all AwsDmsReplicationSubnetGroups in the indexer for a given namespace.
func (s awsDmsReplicationSubnetGroupNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsDmsReplicationSubnetGroup, err error) {
...
// Get retrieves the AwsDmsReplicationSubnetGroup from the indexer for a given namespace and name.
func (s awsDmsReplicationSubnetGroupNamespaceLister) Get(name string) (*v1alpha1.AwsDmsReplicationSubnetGroup, error) {
