...
// List lists all AwsEcrLifecyclePolicies in the indexer for a given namespace.
func (s awsEcrLifecyclePolicyNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsEcrLifecyclePolicy, err error) {
...
// Get retrieves the AwsEcrLifecyclePolicy from the indexer for a given namespace and name.
func (s awsEcrLifecyclePolicyNamespaceLister) Get(name string) (*v1alpha1.AwsEcrLifecyclePolicy, error) {
