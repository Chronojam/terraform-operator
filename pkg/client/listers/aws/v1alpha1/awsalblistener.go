...
// List lists all AwsAlbListeners in the indexer for a given namespace.
func (s awsAlbListenerNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsAlbListener, err error) {
...
// Get retrieves the AwsAlbListener from the indexer for a given namespace and name.
func (s awsAlbListenerNamespaceLister) Get(name string) (*v1alpha1.AwsAlbListener, error) {
