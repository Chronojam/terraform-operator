...
// List lists all AwsAcmCertificateValidations in the indexer for a given namespace.
func (s awsAcmCertificateValidationNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsAcmCertificateValidation, err error) {
...
// Get retrieves the AwsAcmCertificateValidation from the indexer for a given namespace and name.
func (s awsAcmCertificateValidationNamespaceLister) Get(name string) (*v1alpha1.AwsAcmCertificateValidation, error) {
