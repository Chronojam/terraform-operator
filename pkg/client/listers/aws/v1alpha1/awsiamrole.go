...
// List lists all AwsIamRoles in the indexer for a given namespace.
func (s awsIamRoleNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsIamRole, err error) {
...
// Get retrieves the AwsIamRole from the indexer for a given namespace and name.
func (s awsIamRoleNamespaceLister) Get(name string) (*v1alpha1.AwsIamRole, error) {
