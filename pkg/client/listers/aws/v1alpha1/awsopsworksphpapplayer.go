...
// List lists all AwsOpsworksPhpAppLayers in the indexer for a given namespace.
func (s awsOpsworksPhpAppLayerNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsOpsworksPhpAppLayer, err error) {
...
// Get retrieves the AwsOpsworksPhpAppLayer from the indexer for a given namespace and name.
func (s awsOpsworksPhpAppLayerNamespaceLister) Get(name string) (*v1alpha1.AwsOpsworksPhpAppLayer, error) {
