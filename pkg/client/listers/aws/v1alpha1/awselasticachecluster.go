...
// List lists all AwsElasticacheClusters in the indexer for a given namespace.
func (s awsElasticacheClusterNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsElasticacheCluster, err error) {
...
// Get retrieves the AwsElasticacheCluster from the indexer for a given namespace and name.
func (s awsElasticacheClusterNamespaceLister) Get(name string) (*v1alpha1.AwsElasticacheCluster, error) {
