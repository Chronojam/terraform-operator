...
// List lists all AwsEmrSecurityConfigurations in the indexer for a given namespace.
func (s awsEmrSecurityConfigurationNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsEmrSecurityConfiguration, err error) {
...
// Get retrieves the AwsEmrSecurityConfiguration from the indexer for a given namespace and name.
func (s awsEmrSecurityConfigurationNamespaceLister) Get(name string) (*v1alpha1.AwsEmrSecurityConfiguration, error) {
