...
// List lists all AwsVpcDhcpOptionsAssociations in the indexer for a given namespace.
func (s awsVpcDhcpOptionsAssociationNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsVpcDhcpOptionsAssociation, err error) {
...
// Get retrieves the AwsVpcDhcpOptionsAssociation from the indexer for a given namespace and name.
func (s awsVpcDhcpOptionsAssociationNamespaceLister) Get(name string) (*v1alpha1.AwsVpcDhcpOptionsAssociation, error) {
