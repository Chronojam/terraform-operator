...
// List lists all AwsIamUserPolicyAttachments in the indexer for a given namespace.
func (s awsIamUserPolicyAttachmentNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsIamUserPolicyAttachment, err error) {
...
// Get retrieves the AwsIamUserPolicyAttachment from the indexer for a given namespace and name.
func (s awsIamUserPolicyAttachmentNamespaceLister) Get(name string) (*v1alpha1.AwsIamUserPolicyAttachment, error) {
