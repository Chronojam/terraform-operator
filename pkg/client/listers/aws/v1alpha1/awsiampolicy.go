...
// List lists all AwsIamPolicies in the indexer for a given namespace.
func (s awsIamPolicyNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsIamPolicy, err error) {
...
// Get retrieves the AwsIamPolicy from the indexer for a given namespace and name.
func (s awsIamPolicyNamespaceLister) Get(name string) (*v1alpha1.AwsIamPolicy, error) {
