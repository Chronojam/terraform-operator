...
// List lists all AwsLbCookieStickinessPolicies in the indexer for a given namespace.
func (s awsLbCookieStickinessPolicyNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsLbCookieStickinessPolicy, err error) {
...
// Get retrieves the AwsLbCookieStickinessPolicy from the indexer for a given namespace and name.
func (s awsLbCookieStickinessPolicyNamespaceLister) Get(name string) (*v1alpha1.AwsLbCookieStickinessPolicy, error) {
