...
// List lists all AwsLaunchTemplates in the indexer for a given namespace.
func (s awsLaunchTemplateNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsLaunchTemplate, err error) {
...
// Get retrieves the AwsLaunchTemplate from the indexer for a given namespace and name.
func (s awsLaunchTemplateNamespaceLister) Get(name string) (*v1alpha1.AwsLaunchTemplate, error) {
