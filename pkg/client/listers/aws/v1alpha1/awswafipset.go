...
// List lists all AwsWafIpsets in the indexer for a given namespace.
func (s awsWafIpsetNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsWafIpset, err error) {
...
// Get retrieves the AwsWafIpset from the indexer for a given namespace and name.
func (s awsWafIpsetNamespaceLister) Get(name string) (*v1alpha1.AwsWafIpset, error) {
