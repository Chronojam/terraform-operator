...
// List lists all AwsOrganizationsOrganizations in the indexer for a given namespace.
func (s awsOrganizationsOrganizationNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsOrganizationsOrganization, err error) {
...
// Get retrieves the AwsOrganizationsOrganization from the indexer for a given namespace and name.
func (s awsOrganizationsOrganizationNamespaceLister) Get(name string) (*v1alpha1.AwsOrganizationsOrganization, error) {
