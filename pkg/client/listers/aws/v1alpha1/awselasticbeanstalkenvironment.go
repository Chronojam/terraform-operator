...
// List lists all AwsElasticBeanstalkEnvironments in the indexer for a given namespace.
func (s awsElasticBeanstalkEnvironmentNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsElasticBeanstalkEnvironment, err error) {
...
// Get retrieves the AwsElasticBeanstalkEnvironment from the indexer for a given namespace and name.
func (s awsElasticBeanstalkEnvironmentNamespaceLister) Get(name string) (*v1alpha1.AwsElasticBeanstalkEnvironment, error) {
