...
// List lists all AwsAutoscalingSchedules in the indexer for a given namespace.
func (s awsAutoscalingScheduleNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsAutoscalingSchedule, err error) {
...
// Get retrieves the AwsAutoscalingSchedule from the indexer for a given namespace and name.
func (s awsAutoscalingScheduleNamespaceLister) Get(name string) (*v1alpha1.AwsAutoscalingSchedule, error) {
