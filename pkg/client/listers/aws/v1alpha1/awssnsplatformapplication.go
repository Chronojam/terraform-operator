...
// List lists all AwsSnsPlatformApplications in the indexer for a given namespace.
func (s awsSnsPlatformApplicationNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsSnsPlatformApplication, err error) {
...
// Get retrieves the AwsSnsPlatformApplication from the indexer for a given namespace and name.
func (s awsSnsPlatformApplicationNamespaceLister) Get(name string) (*v1alpha1.AwsSnsPlatformApplication, error) {
