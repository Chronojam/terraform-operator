...
// List lists all AwsVolumeAttachments in the indexer for a given namespace.
func (s awsVolumeAttachmentNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsVolumeAttachment, err error) {
...
// Get retrieves the AwsVolumeAttachment from the indexer for a given namespace and name.
func (s awsVolumeAttachmentNamespaceLister) Get(name string) (*v1alpha1.AwsVolumeAttachment, error) {
