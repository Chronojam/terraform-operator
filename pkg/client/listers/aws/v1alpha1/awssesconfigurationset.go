...
// List lists all AwsSesConfigurationSets in the indexer for a given namespace.
func (s awsSesConfigurationSetNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsSesConfigurationSet, err error) {
...
// Get retrieves the AwsSesConfigurationSet from the indexer for a given namespace and name.
func (s awsSesConfigurationSetNamespaceLister) Get(name string) (*v1alpha1.AwsSesConfigurationSet, error) {
