...
// List lists all AwsDefaultVpcDhcpOptionses in the indexer for a given namespace.
func (s awsDefaultVpcDhcpOptionsNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsDefaultVpcDhcpOptions, err error) {
...
// Get retrieves the AwsDefaultVpcDhcpOptions from the indexer for a given namespace and name.
func (s awsDefaultVpcDhcpOptionsNamespaceLister) Get(name string) (*v1alpha1.AwsDefaultVpcDhcpOptions, error) {
