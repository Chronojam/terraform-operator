...
// List lists all AwsIamGroups in the indexer for a given namespace.
func (s awsIamGroupNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsIamGroup, err error) {
...
// Get retrieves the AwsIamGroup from the indexer for a given namespace and name.
func (s awsIamGroupNamespaceLister) Get(name string) (*v1alpha1.AwsIamGroup, error) {
