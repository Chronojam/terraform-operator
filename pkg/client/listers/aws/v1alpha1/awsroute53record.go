...
// List lists all AwsRoute53Records in the indexer for a given namespace.
func (s awsRoute53RecordNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsRoute53Record, err error) {
...
// Get retrieves the AwsRoute53Record from the indexer for a given namespace and name.
func (s awsRoute53RecordNamespaceLister) Get(name string) (*v1alpha1.AwsRoute53Record, error) {
