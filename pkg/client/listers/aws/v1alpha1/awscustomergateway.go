...
// List lists all AwsCustomerGateways in the indexer for a given namespace.
func (s awsCustomerGatewayNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsCustomerGateway, err error) {
...
// Get retrieves the AwsCustomerGateway from the indexer for a given namespace and name.
func (s awsCustomerGatewayNamespaceLister) Get(name string) (*v1alpha1.AwsCustomerGateway, error) {
