...
// List lists all AwsLbs in the indexer for a given namespace.
func (s awsLbNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsLb, err error) {
...
// Get retrieves the AwsLb from the indexer for a given namespace and name.
func (s awsLbNamespaceLister) Get(name string) (*v1alpha1.AwsLb, error) {
