...
// List lists all AwsDbInstances in the indexer for a given namespace.
func (s awsDbInstanceNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsDbInstance, err error) {
...
// Get retrieves the AwsDbInstance from the indexer for a given namespace and name.
func (s awsDbInstanceNamespaceLister) Get(name string) (*v1alpha1.AwsDbInstance, error) {
