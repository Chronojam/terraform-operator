...
// List lists all AwsDmsEndpoints in the indexer for a given namespace.
func (s awsDmsEndpointNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsDmsEndpoint, err error) {
...
// Get retrieves the AwsDmsEndpoint from the indexer for a given namespace and name.
func (s awsDmsEndpointNamespaceLister) Get(name string) (*v1alpha1.AwsDmsEndpoint, error) {
