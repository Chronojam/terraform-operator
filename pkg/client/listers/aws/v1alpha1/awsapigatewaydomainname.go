...
// List lists all AwsApiGatewayDomainNames in the indexer for a given namespace.
func (s awsApiGatewayDomainNameNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsApiGatewayDomainName, err error) {
...
// Get retrieves the AwsApiGatewayDomainName from the indexer for a given namespace and name.
func (s awsApiGatewayDomainNameNamespaceLister) Get(name string) (*v1alpha1.AwsApiGatewayDomainName, error) {
