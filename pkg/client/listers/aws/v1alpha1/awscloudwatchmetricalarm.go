...
// List lists all AwsCloudwatchMetricAlarms in the indexer for a given namespace.
func (s awsCloudwatchMetricAlarmNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsCloudwatchMetricAlarm, err error) {
...
// Get retrieves the AwsCloudwatchMetricAlarm from the indexer for a given namespace and name.
func (s awsCloudwatchMetricAlarmNamespaceLister) Get(name string) (*v1alpha1.AwsCloudwatchMetricAlarm, error) {
