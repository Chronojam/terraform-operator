...
// List lists all AwsSesDomainDkims in the indexer for a given namespace.
func (s awsSesDomainDkimNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsSesDomainDkim, err error) {
...
// Get retrieves the AwsSesDomainDkim from the indexer for a given namespace and name.
func (s awsSesDomainDkimNamespaceLister) Get(name string) (*v1alpha1.AwsSesDomainDkim, error) {
