...
// List lists all AwsCognitoUserPools in the indexer for a given namespace.
func (s awsCognitoUserPoolNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsCognitoUserPool, err error) {
...
// Get retrieves the AwsCognitoUserPool from the indexer for a given namespace and name.
func (s awsCognitoUserPoolNamespaceLister) Get(name string) (*v1alpha1.AwsCognitoUserPool, error) {
