...
// List lists all AwsRouteTableAssociations in the indexer for a given namespace.
func (s awsRouteTableAssociationNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsRouteTableAssociation, err error) {
...
// Get retrieves the AwsRouteTableAssociation from the indexer for a given namespace and name.
func (s awsRouteTableAssociationNamespaceLister) Get(name string) (*v1alpha1.AwsRouteTableAssociation, error) {
