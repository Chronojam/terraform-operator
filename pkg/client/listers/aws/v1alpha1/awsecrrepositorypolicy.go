...
// List lists all AwsEcrRepositoryPolicies in the indexer for a given namespace.
func (s awsEcrRepositoryPolicyNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsEcrRepositoryPolicy, err error) {
...
// Get retrieves the AwsEcrRepositoryPolicy from the indexer for a given namespace and name.
func (s awsEcrRepositoryPolicyNamespaceLister) Get(name string) (*v1alpha1.AwsEcrRepositoryPolicy, error) {
