...
// List lists all AwsSesDomainIdentityVerifications in the indexer for a given namespace.
func (s awsSesDomainIdentityVerificationNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsSesDomainIdentityVerification, err error) {
...
// Get retrieves the AwsSesDomainIdentityVerification from the indexer for a given namespace and name.
func (s awsSesDomainIdentityVerificationNamespaceLister) Get(name string) (*v1alpha1.AwsSesDomainIdentityVerification, error) {
