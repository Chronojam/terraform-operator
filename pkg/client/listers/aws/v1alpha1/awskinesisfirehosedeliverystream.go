...
// List lists all AwsKinesisFirehoseDeliveryStreams in the indexer for a given namespace.
func (s awsKinesisFirehoseDeliveryStreamNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsKinesisFirehoseDeliveryStream, err error) {
...
// Get retrieves the AwsKinesisFirehoseDeliveryStream from the indexer for a given namespace and name.
func (s awsKinesisFirehoseDeliveryStreamNamespaceLister) Get(name string) (*v1alpha1.AwsKinesisFirehoseDeliveryStream, error) {
