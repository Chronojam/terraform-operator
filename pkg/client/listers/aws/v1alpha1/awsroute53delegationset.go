...
// List lists all AwsRoute53DelegationSets in the indexer for a given namespace.
func (s awsRoute53DelegationSetNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsRoute53DelegationSet, err error) {
...
// Get retrieves the AwsRoute53DelegationSet from the indexer for a given namespace and name.
func (s awsRoute53DelegationSetNamespaceLister) Get(name string) (*v1alpha1.AwsRoute53DelegationSet, error) {
