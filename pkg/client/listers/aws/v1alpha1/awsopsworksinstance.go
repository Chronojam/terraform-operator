...
// List lists all AwsOpsworksInstances in the indexer for a given namespace.
func (s awsOpsworksInstanceNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsOpsworksInstance, err error) {
...
// Get retrieves the AwsOpsworksInstance from the indexer for a given namespace and name.
func (s awsOpsworksInstanceNamespaceLister) Get(name string) (*v1alpha1.AwsOpsworksInstance, error) {
