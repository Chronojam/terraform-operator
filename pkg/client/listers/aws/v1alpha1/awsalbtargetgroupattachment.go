...
// List lists all AwsAlbTargetGroupAttachments in the indexer for a given namespace.
func (s awsAlbTargetGroupAttachmentNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsAlbTargetGroupAttachment, err error) {
...
// Get retrieves the AwsAlbTargetGroupAttachment from the indexer for a given namespace and name.
func (s awsAlbTargetGroupAttachmentNamespaceLister) Get(name string) (*v1alpha1.AwsAlbTargetGroupAttachment, error) {
