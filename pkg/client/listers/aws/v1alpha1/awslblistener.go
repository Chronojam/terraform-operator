...
// List lists all AwsLbListeners in the indexer for a given namespace.
func (s awsLbListenerNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsLbListener, err error) {
...
// Get retrieves the AwsLbListener from the indexer for a given namespace and name.
func (s awsLbListenerNamespaceLister) Get(name string) (*v1alpha1.AwsLbListener, error) {
