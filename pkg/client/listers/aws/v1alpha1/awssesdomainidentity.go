...
// List lists all AwsSesDomainIdentities in the indexer for a given namespace.
func (s awsSesDomainIdentityNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsSesDomainIdentity, err error) {
...
// Get retrieves the AwsSesDomainIdentity from the indexer for a given namespace and name.
func (s awsSesDomainIdentityNamespaceLister) Get(name string) (*v1alpha1.AwsSesDomainIdentity, error) {
