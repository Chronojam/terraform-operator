...
// List lists all AwsSsmMaintenanceWindowTasks in the indexer for a given namespace.
func (s awsSsmMaintenanceWindowTaskNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsSsmMaintenanceWindowTask, err error) {
...
// Get retrieves the AwsSsmMaintenanceWindowTask from the indexer for a given namespace and name.
func (s awsSsmMaintenanceWindowTaskNamespaceLister) Get(name string) (*v1alpha1.AwsSsmMaintenanceWindowTask, error) {
