...
// List lists all AwsServicecatalogPortfolios in the indexer for a given namespace.
func (s awsServicecatalogPortfolioNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsServicecatalogPortfolio, err error) {
...
// Get retrieves the AwsServicecatalogPortfolio from the indexer for a given namespace and name.
func (s awsServicecatalogPortfolioNamespaceLister) Get(name string) (*v1alpha1.AwsServicecatalogPortfolio, error) {
