...
// List lists all AwsSsmMaintenanceWindowTargets in the indexer for a given namespace.
func (s awsSsmMaintenanceWindowTargetNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsSsmMaintenanceWindowTarget, err error) {
...
// Get retrieves the AwsSsmMaintenanceWindowTarget from the indexer for a given namespace and name.
func (s awsSsmMaintenanceWindowTargetNamespaceLister) Get(name string) (*v1alpha1.AwsSsmMaintenanceWindowTarget, error) {
