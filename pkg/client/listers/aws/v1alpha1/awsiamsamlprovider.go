...
// List lists all AwsIamSamlProviders in the indexer for a given namespace.
func (s awsIamSamlProviderNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsIamSamlProvider, err error) {
...
// Get retrieves the AwsIamSamlProvider from the indexer for a given namespace and name.
func (s awsIamSamlProviderNamespaceLister) Get(name string) (*v1alpha1.AwsIamSamlProvider, error) {
