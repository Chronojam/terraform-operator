...
// List lists all AwsDmsReplicationInstances in the indexer for a given namespace.
func (s awsDmsReplicationInstanceNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsDmsReplicationInstance, err error) {
...
// Get retrieves the AwsDmsReplicationInstance from the indexer for a given namespace and name.
func (s awsDmsReplicationInstanceNamespaceLister) Get(name string) (*v1alpha1.AwsDmsReplicationInstance, error) {
