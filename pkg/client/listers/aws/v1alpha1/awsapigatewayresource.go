...
// List lists all AwsApiGatewayResources in the indexer for a given namespace.
func (s awsApiGatewayResourceNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsApiGatewayResource, err error) {
...
// Get retrieves the AwsApiGatewayResource from the indexer for a given namespace and name.
func (s awsApiGatewayResourceNamespaceLister) Get(name string) (*v1alpha1.AwsApiGatewayResource, error) {
