...
// List lists all AwsEcrRepositories in the indexer for a given namespace.
func (s awsEcrRepositoryNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsEcrRepository, err error) {
...
// Get retrieves the AwsEcrRepository from the indexer for a given namespace and name.
func (s awsEcrRepositoryNamespaceLister) Get(name string) (*v1alpha1.AwsEcrRepository, error) {
