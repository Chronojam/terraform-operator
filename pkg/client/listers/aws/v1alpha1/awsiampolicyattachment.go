...
// List lists all AwsIamPolicyAttachments in the indexer for a given namespace.
func (s awsIamPolicyAttachmentNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsIamPolicyAttachment, err error) {
...
// Get retrieves the AwsIamPolicyAttachment from the indexer for a given namespace and name.
func (s awsIamPolicyAttachmentNamespaceLister) Get(name string) (*v1alpha1.AwsIamPolicyAttachment, error) {
