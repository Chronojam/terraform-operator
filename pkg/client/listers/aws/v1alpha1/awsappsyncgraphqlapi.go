...
// List lists all AwsAppsyncGraphqlApis in the indexer for a given namespace.
func (s awsAppsyncGraphqlApiNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsAppsyncGraphqlApi, err error) {
...
// Get retrieves the AwsAppsyncGraphqlApi from the indexer for a given namespace and name.
func (s awsAppsyncGraphqlApiNamespaceLister) Get(name string) (*v1alpha1.AwsAppsyncGraphqlApi, error) {
