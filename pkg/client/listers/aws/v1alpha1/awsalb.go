...
// List lists all AwsAlbs in the indexer for a given namespace.
func (s awsAlbNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsAlb, err error) {
...
// Get retrieves the AwsAlb from the indexer for a given namespace and name.
func (s awsAlbNamespaceLister) Get(name string) (*v1alpha1.AwsAlb, error) {
