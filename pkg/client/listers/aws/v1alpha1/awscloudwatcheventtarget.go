...
// List lists all AwsCloudwatchEventTargets in the indexer for a given namespace.
func (s awsCloudwatchEventTargetNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsCloudwatchEventTarget, err error) {
...
// Get retrieves the AwsCloudwatchEventTarget from the indexer for a given namespace and name.
func (s awsCloudwatchEventTargetNamespaceLister) Get(name string) (*v1alpha1.AwsCloudwatchEventTarget, error) {
