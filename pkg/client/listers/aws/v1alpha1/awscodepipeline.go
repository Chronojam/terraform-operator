...
// List lists all AwsCodepipelines in the indexer for a given namespace.
func (s awsCodepipelineNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsCodepipeline, err error) {
...
// Get retrieves the AwsCodepipeline from the indexer for a given namespace and name.
func (s awsCodepipelineNamespaceLister) Get(name string) (*v1alpha1.AwsCodepipeline, error) {
