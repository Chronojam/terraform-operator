...
// List lists all AwsGameliftFleets in the indexer for a given namespace.
func (s awsGameliftFleetNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsGameliftFleet, err error) {
...
// Get retrieves the AwsGameliftFleet from the indexer for a given namespace and name.
func (s awsGameliftFleetNamespaceLister) Get(name string) (*v1alpha1.AwsGameliftFleet, error) {
