...
// List lists all AwsNetworkAcls in the indexer for a given namespace.
func (s awsNetworkAclNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsNetworkAcl, err error) {
...
// Get retrieves the AwsNetworkAcl from the indexer for a given namespace and name.
func (s awsNetworkAclNamespaceLister) Get(name string) (*v1alpha1.AwsNetworkAcl, error) {
