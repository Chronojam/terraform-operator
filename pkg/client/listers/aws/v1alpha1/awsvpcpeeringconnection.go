...
// List lists all AwsVpcPeeringConnections in the indexer for a given namespace.
func (s awsVpcPeeringConnectionNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsVpcPeeringConnection, err error) {
...
// Get retrieves the AwsVpcPeeringConnection from the indexer for a given namespace and name.
func (s awsVpcPeeringConnectionNamespaceLister) Get(name string) (*v1alpha1.AwsVpcPeeringConnection, error) {
