...
// List lists all AwsWafRateBasedRules in the indexer for a given namespace.
func (s awsWafRateBasedRuleNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsWafRateBasedRule, err error) {
...
// Get retrieves the AwsWafRateBasedRule from the indexer for a given namespace and name.
func (s awsWafRateBasedRuleNamespaceLister) Get(name string) (*v1alpha1.AwsWafRateBasedRule, error) {
