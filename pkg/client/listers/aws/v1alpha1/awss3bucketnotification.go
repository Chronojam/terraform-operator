...
// List lists all AwsS3BucketNotifications in the indexer for a given namespace.
func (s awsS3BucketNotificationNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsS3BucketNotification, err error) {
...
// Get retrieves the AwsS3BucketNotification from the indexer for a given namespace and name.
func (s awsS3BucketNotificationNamespaceLister) Get(name string) (*v1alpha1.AwsS3BucketNotification, error) {
