...
// List lists all AwsInternetGateways in the indexer for a given namespace.
func (s awsInternetGatewayNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsInternetGateway, err error) {
...
// Get retrieves the AwsInternetGateway from the indexer for a given namespace and name.
func (s awsInternetGatewayNamespaceLister) Get(name string) (*v1alpha1.AwsInternetGateway, error) {
