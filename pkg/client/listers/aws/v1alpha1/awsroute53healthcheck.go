...
// List lists all AwsRoute53HealthChecks in the indexer for a given namespace.
func (s awsRoute53HealthCheckNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsRoute53HealthCheck, err error) {
...
// Get retrieves the AwsRoute53HealthCheck from the indexer for a given namespace and name.
func (s awsRoute53HealthCheckNamespaceLister) Get(name string) (*v1alpha1.AwsRoute53HealthCheck, error) {
