...
// List lists all AwsLbSslNegotiationPolicies in the indexer for a given namespace.
func (s awsLbSslNegotiationPolicyNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsLbSslNegotiationPolicy, err error) {
...
// Get retrieves the AwsLbSslNegotiationPolicy from the indexer for a given namespace and name.
func (s awsLbSslNegotiationPolicyNamespaceLister) Get(name string) (*v1alpha1.AwsLbSslNegotiationPolicy, error) {
