...
// List lists all AwsInspectorAssessmentTemplates in the indexer for a given namespace.
func (s awsInspectorAssessmentTemplateNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsInspectorAssessmentTemplate, err error) {
...
// Get retrieves the AwsInspectorAssessmentTemplate from the indexer for a given namespace and name.
func (s awsInspectorAssessmentTemplateNamespaceLister) Get(name string) (*v1alpha1.AwsInspectorAssessmentTemplate, error) {
