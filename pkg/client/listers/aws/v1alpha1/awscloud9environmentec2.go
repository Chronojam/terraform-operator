...
// List lists all AwsCloud9EnvironmentEc2s in the indexer for a given namespace.
func (s awsCloud9EnvironmentEc2NamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsCloud9EnvironmentEc2, err error) {
...
// Get retrieves the AwsCloud9EnvironmentEc2 from the indexer for a given namespace and name.
func (s awsCloud9EnvironmentEc2NamespaceLister) Get(name string) (*v1alpha1.AwsCloud9EnvironmentEc2, error) {
