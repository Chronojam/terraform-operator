...
// List lists all AwsApiGatewayRequestValidators in the indexer for a given namespace.
func (s awsApiGatewayRequestValidatorNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsApiGatewayRequestValidator, err error) {
...
// Get retrieves the AwsApiGatewayRequestValidator from the indexer for a given namespace and name.
func (s awsApiGatewayRequestValidatorNamespaceLister) Get(name string) (*v1alpha1.AwsApiGatewayRequestValidator, error) {
