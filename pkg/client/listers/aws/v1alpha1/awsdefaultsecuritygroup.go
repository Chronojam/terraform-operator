...
// List lists all AwsDefaultSecurityGroups in the indexer for a given namespace.
func (s awsDefaultSecurityGroupNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsDefaultSecurityGroup, err error) {
...
// Get retrieves the AwsDefaultSecurityGroup from the indexer for a given namespace and name.
func (s awsDefaultSecurityGroupNamespaceLister) Get(name string) (*v1alpha1.AwsDefaultSecurityGroup, error) {
