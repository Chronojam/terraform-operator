...
// List lists all AwsRoute53QueryLogs in the indexer for a given namespace.
func (s awsRoute53QueryLogNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.AwsRoute53QueryLog, err error) {
...
// Get retrieves the AwsRoute53QueryLog from the indexer for a given namespace and name.
func (s awsRoute53QueryLogNamespaceLister) Get(name string) (*v1alpha1.AwsRoute53QueryLog, error) {
