package awselasticbeanstalkapplicationversion
...
const ResourceName="aws_elastic_beanstalk_application_version"
type Handler struct{}
...
func (t *Handler) ObjectCreated(obj interface{}) {
    o := obj.(*v1alpha1.AwsElasticBeanstalkApplicationVersion)
