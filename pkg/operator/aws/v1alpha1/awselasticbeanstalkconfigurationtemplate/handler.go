package awselasticbeanstalkconfigurationtemplate
...
const ResourceName="aws_elastic_beanstalk_configuration_template"
type Handler struct{}
...
func (t *Handler) ObjectCreated(obj interface{}) {
    o := obj.(*v1alpha1.AwsElasticBeanstalkConfigurationTemplate)
