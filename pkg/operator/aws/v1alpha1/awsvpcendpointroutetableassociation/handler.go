package awsvpcendpointroutetableassociation
...
const ResourceName="aws_vpc_endpoint_route_table_association"
type Handler struct{}
...
func (t *Handler) ObjectCreated(obj interface{}) {
    o := obj.(*v1alpha1.AwsVpcEndpointRouteTableAssociation)
