package awsdirectoryserviceconditionalforwarder
...
const ResourceName="aws_directory_service_conditional_forwarder"
type Handler struct{}
...
func (t *Handler) ObjectCreated(obj interface{}) {
    o := obj.(*v1alpha1.AwsDirectoryServiceConditionalForwarder)
