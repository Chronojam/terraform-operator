package awsconfigconfigurationrecorderstatus
...
const ResourceName="aws_config_configuration_recorder_status"
type Handler struct{}
...
func (t *Handler) ObjectCreated(obj interface{}) {
    o := obj.(*v1alpha1.AwsConfigConfigurationRecorderStatus)
