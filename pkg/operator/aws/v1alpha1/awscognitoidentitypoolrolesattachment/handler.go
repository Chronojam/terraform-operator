package awscognitoidentitypoolrolesattachment
...
const ResourceName="aws_cognito_identity_pool_roles_attachment"
type Handler struct{}
...
func (t *Handler) ObjectCreated(obj interface{}) {
    o := obj.(*v1alpha1.AwsCognitoIdentityPoolRolesAttachment)
