package awsservicediscoverypublicdnsnamespace
...
const ResourceName="aws_service_discovery_public_dns_namespace"
type Handler struct{}
...
func (t *Handler) ObjectCreated(obj interface{}) {
    o := obj.(*v1alpha1.AwsServiceDiscoveryPublicDnsNamespace)
