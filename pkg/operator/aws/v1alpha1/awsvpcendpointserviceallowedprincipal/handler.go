package awsvpcendpointserviceallowedprincipal
...
const ResourceName="aws_vpc_endpoint_service_allowed_principal"
type Handler struct{}
...
func (t *Handler) ObjectCreated(obj interface{}) {
    o := obj.(*v1alpha1.AwsVpcEndpointServiceAllowedPrincipal)
