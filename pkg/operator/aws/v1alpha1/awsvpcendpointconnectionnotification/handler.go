package awsvpcendpointconnectionnotification
...
const ResourceName="aws_vpc_endpoint_connection_notification"
type Handler struct{}
...
func (t *Handler) ObjectCreated(obj interface{}) {
    o := obj.(*v1alpha1.AwsVpcEndpointConnectionNotification)
